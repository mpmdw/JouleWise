...
PACK_REL = Path("configs/campaigns/d117_floor_qwen25_7b_v3")
CALIBRATION_PLAN_REFERENCE = "calibration_plan.json"
CURRENT_FAMILY_SUFFIX = "_v3"
...
N = 10
PLAN_ID = "plan-d117-floor-qwen25-7b-decode-p128-prefill-rider-v3"
EVIDENCE_ROOT_ID = "evidence-d117-floor-qwen25-7b-v3"
CLAIM_ROOT_LEAF = "runs_d117_floor_qwen25_7b_v3"
BOUND_ROOT_LEAF = "runs_d117_floor_qwen25_7b_v3_bound"
...
CAMPAIGN_TAG = "d117-floor-qwen25-7b-v3"
...
CURRENT_FROZEN_RECEIPT_SHA256 = (
    "decd8cdc6a589397e28240b33b97e1b38575be860490a2c6de31be51611842d0"
)
...
PLAN_SET_ID = "plan-set-d117-qwen25-1p5b-7b-phase-floor-v3"
AGGREGATE_ARTIFACT_ID = "d117-qwen25-phase-floor-set-v3"
COMPONENT_ARTIFACT_ID = "d117-qwen25-7b-phase-floor-component-v3"

DECODE_ARTIFACT_CELL_ID = "d117-qwen25-7b-decode-floor-v3"
PREFILL_ARTIFACT_CELL_ID = "d117-qwen25-7b-prefill-p128-floor-v3"
DECODE_TRANSPORT_ID = "tg-d117-qwen25-7b-decode-v3"
PREFILL_TRANSPORT_ID = "tg-d117-qwen25-7b-prefill-p128-v3"
...
EXPECTED_EXTERNAL_SHA256 = {
    ...
    SUCCESSOR_ACCEPTANCE_REL.as_posix(): "0227bca3f826edc7f0a1baf98a394df01d8f48e9609966088870d712f765697d",
...
_SUCCESSOR_IDENTITY_TOKENS = (
    ...
    "evidence-d117-floor-qwen25-7b-v3",
    "plan-set-d117-qwen25-1p5b-7b-phase-floor-v3",
    "d117-qwen25-phase-floor-set-v3",
    "d117-qwen25-7b-phase-floor-component-v3",
    "d117-qwen25-7b-prefill-p256-floor-v3",
    "d117-qwen25-7b-prefill-p128-floor-v3",
    "d117-qwen25-7b-decode-floor-v3",
    "tg-d117-qwen25-7b-prefill-p256-v3",
    "tg-d117-qwen25-7b-prefill-p128-v3",
    "tg-d117-qwen25-7b-decode-v3",
    ...
    *,
    ...
    return {
        ...
        "roles": [
            ...
            {
                "role": "prefill_p256",
                "artifact_cell_id": "d117-qwen25-7b-prefill-p256-floor-v3",
                "transport_group_id": "tg-d117-qwen25-7b-prefill-p256-v3",
                "metric": "phase_energy_j.prefill",
                "target_precheck_path": ["phase", "prefill"],
                "condition_family_id": P256_FAMILY_ID,
...
def _build_artifacts() -> dict[Path, bytes]:
    ...
    for stage in stages:
        ...
        for local_index, run in enumerate(stage["runs"], start=1):
            ...
            root_index += 1
        manifest_id = (
            f"d117-floor-qwen25-7b-v3-{stage_id.replace('_', '-')}-order-v1"
        )
        leaf_manifest = {
    ...
    root_manifest_id = "d117-floor-qwen25-7b-v3-order-v1"
    root_manifest = {
        "schema_version": ORDER_SCHEMA,
