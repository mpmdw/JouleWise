#!/usr/bin/env python3
"""Generate the D-117 Qwen3-8B floor campaign draft deterministically."""
...
PACK_REL = Path("configs/campaigns/d117_floor_qwen3-8b_v5")
...
PLAN_ID = "plan-d117-floor-qwen3-8b-decode-prefill-p512-v5"
EVIDENCE_ROOT_ID = "evidence-d117-floor-qwen3-8b-v5"
CLAIM_ROOT_LEAF = "runs_d117_floor_qwen3-8b_v5"
BOUND_ROOT_LEAF = "runs_d117_floor_qwen3-8b_v5_bound"
CAMPAIGN_TAG = "d117-floor-qwen3-8b-v5"
...
DECODE_FAMILY_ID = "df-ph-decode-qwen3-8b"
PREFILL_FAMILY_ID = "df-ph-prefill-p42-qwen3-8b"
P512_FAMILY_ID = "df-ph-prefill-p512-qwen3-8b"
DECODE_FAMILY_REL = PACK_REL / "condition_families/condition_family_df_ph_decode.json"
PREFILL_FAMILY_REL = (
    PACK_REL
    / "condition_families/condition_family_df_ph_prefill_p42_qwen3_8b.json"
)
P512_FAMILY_REL = (
    PACK_REL
    / "condition_families/condition_family_df_ph_prefill_p512_qwen3_8b.json"
)
...
_SUCCESSOR_IDENTITY_TOKENS = (
    ...
    "evidence-d117-floor-qwen3-8b-v5",
    "plan-set-d117-qwen3-1p7b-8b-phase-floor-v5",
    "d117-qwen3-phase-floor-set-v5",
    "d117-qwen3-8b-phase-floor-component-v5",
    "d117-qwen3-8b-prefill-p512-floor-v5",
    "d117-qwen3-8b-prefill-p42-floor-v5",
    "d117-qwen3-8b-decode-floor-v5",
    "tg-d117-qwen3-8b-prefill-p512-v5",
    "tg-d117-qwen3-8b-prefill-p42-v5",
    "tg-d117-qwen3-8b-decode-v5",
...
HARDWARE = {
    ...
    "notes": (
        "D-117 beta Qwen3-8B production floor campaign on the current "
...
def build_assembly() -> tuple[
    ...
    for rep in range(1, N + 1):
        run_id = f"d117fq38-df-ph-decode-abs-r{rep:02d}"
        run = {
            "run_id": run_id,
    ...
    for block in range(1, N + 1):
        block_id = f"d117-df-cmp-abba-ph-decode-qwen3-8b-b{block:02d}"
        members: dict[str, str] = {}
        for sequence_index, (label, position) in enumerate(positions, start=1):
            run_id = (
                f"d117fq38-df-cmp-abba-ph-decode-b{block:02d}-"
                f"{position.lower()}"
            )
            run = {
                "run_id": run_id,
...
def stage_graph(
    ...
    stages: list[dict[str, Any]] = [
        ...
        {
            "stage_id": "beta-pre-calibration",
            "kind": "calibration_capture",
            "expected_count": 1,
            "input": {"kind": "arm_bindings", "slot": "pre"},
            "launch": launch_recipe(
                "beta-pre-calibration.capture",
                "calibration_capture",
                "fiducial_capture",
        ...
        {
            "stage_id": "beta-bound-collection",
        ...
        {
            "stage_id": "beta-bound-derivation",
        ...
        {
            "stage_id": "beta-reference-start",
            "kind": "campaign_collection",
            "expected_count": 3,
            "input": external_inputs["start_reference"]["manifest"],
            "launch": campaign_launch(
                "beta-reference-start", START_MANIFEST_REL.parent, "claim_runs_root"
            ),
        },
        {
            "stage_id": "beta-science-absolute",
            "kind": "campaign_collection",
            "expected_count": 10,
        ...
        {
            "stage_id": "beta-science-abba-01-05",
            "kind": "campaign_collection",
            "expected_count": 20,
        ...
        {
            "stage_id": "beta-science-abba-06-10",
            "kind": "campaign_collection",
            "expected_count": 20,
        ...
        {
            "stage_id": "beta-reference-midpoint",
            "kind": "campaign_collection",
            "expected_count": 1,
            "input": external_inputs["midpoint_reference"]["manifest"],
            "launch": campaign_launch(
                "beta-reference-midpoint", MIDPOINT_MANIFEST_REL.parent, "claim_runs_root"
            ),
        },
        {
        ...
        {
            "stage_id": "beta-reference-end",
            "kind": "campaign_collection",
            "expected_count": 3,
            "input": external_inputs["end_reference"]["manifest"],
            "launch": campaign_launch(
                "beta-reference-end", END_MANIFEST_REL.parent, "claim_runs_root"
            ),
        },
        {
            "stage_id": "beta-post-calibration",
            "kind": "calibration_capture",
            "expected_count": 1,
            "input": {"kind": "arm_bindings", "slot": "post"},
            "launch": launch_recipe(
                "beta-post-calibration.capture",
                "calibration_capture",
                "fiducial_capture",
                "joulewise.powermetrics_fiducial.cli.v1",
                post_capture,
        ...
        {
            "stage_id": "beta-whole-window-verdict",
            "kind": "whole_window_verdict",
            "expected_count": 1,
            "input": {"kind": "collected_roots"},
            "launch": launch_recipe(
                "beta-whole-window-verdict.evaluate",
...
def build_extraction_spec(
    ...
    order_binding = {
        ...
        "manifest_id": "d117-floor-qwen3-8b-v5-order-v1",
    ...
    cells = [
        absolute_cell(
            "d117-df-ph-decode-qwen3-8b-absolute",
        ...
        comparative_cell(
            "d117-df-cmp-abba-ph-decode-qwen3-8b",
            "phase_energy_j.decode",
            ["phase", "decode"],
            DECODE_FAMILY_ID,
            decode_definition,
        ...
        absolute_cell(
            "d117-df-ph-prefill-p42-qwen3-8b-absolute",
        ...
        comparative_cell(
            "d117-df-cmp-abba-ph-prefill-p42-qwen3-8b",
            "phase_energy_j.prefill",
            ["phase", "prefill"],
            PREFILL_FAMILY_ID,
            prefill_definition,
    ...
    reported_cells = [
        {
            "cell_id": "d117-reported-mean-ph-decode-qwen3-8b",
            "metric": "phase_energy_j.decode",
            "window_class": "phase",
        ...
        {
            "cell_id": "d117-reported-mean-ph-prefill-p42-qwen3-8b",
            "metric": "phase_energy_j.prefill",
            "window_class": "phase",
...
def build_producer_contract(
    ...
    roles = [
        {
            "role": "decode",
            "artifact_cell_id": "d117-qwen3-8b-decode-floor-v5",
            "transport_group_id": "tg-d117-qwen3-8b-decode-v5",
            "metric": "phase_energy_j.decode",
            "target_precheck_path": ["phase", "decode"],
            "condition_family_id": DECODE_FAMILY_ID,
            "absolute_calibration_cell_id": "d117-df-ph-decode-qwen3-8b-absolute",
            "comparative_calibration_cell_id": "d117-df-cmp-abba-ph-decode-qwen3-8b",
            "allowed_consumer_families": ["sw-decode-b-qwen3-8b"],
            "members": decode_config_rows,
        },
        {
            "role": "prefill",
            "artifact_cell_id": "d117-qwen3-8b-prefill-p42-floor-v5",
            "transport_group_id": "tg-d117-qwen3-8b-prefill-p42-v5",
            "metric": "phase_energy_j.prefill",
            "target_precheck_path": ["phase", "prefill"],
            "condition_family_id": PREFILL_FAMILY_ID,
            "absolute_calibration_cell_id": "d117-df-ph-prefill-p42-qwen3-8b-absolute",
            "comparative_calibration_cell_id": "d117-df-cmp-abba-ph-prefill-p42-qwen3-8b",
            "allowed_consumer_families": ["df-ph-prefill-p42-qwen3-8b"],
            "members": decode_config_rows,
        },
        {
            "role": "prefill_p512",
    ...
    return {
        ...
        "component_artifact_id": "d117-qwen3-8b-phase-floor-component-v5",
...
def readme_bytes() -> bytes:
    ...
    if identity.target_is_successor_family:
        content = (
            "# D-117 Qwen3-8B floor campaign — status governed by the "
            ...
            "```text\n"
            "python3 configs/campaigns/d117_floor_qwen3-8b_v5/generate_configs.py "
            "--prefill-prompt-pin /path/to/issued/prefill-prompt-pin.json\n"
            "python3 configs/campaigns/d117_floor_qwen3-8b_v5/generate_configs.py --check\n"
            "```\n\n"
    ...
    content = (
        "# D-117 Qwen3-8B floor campaign — unfrozen draft\n\n"
        f"{identity_statement}"
        "This pack pre-registers the beta window's 10 absolute decode members, "
        "ten null A/B/B/A blocks (40 members), and a zero-member prefill metric "
        "rider over the same 50 physical bundles. It also carries a dedicated "
...
def _generate(output_root: Path) -> tuple[int, str, str]:
    ...
    plan = {
        ...
        "floor_cells": [
            {
                "cell_id": "d117-df-ph-decode-qwen3-8b-absolute",
                "kind": "absolute",
                "metric": "phase_energy_j.decode",
                "condition_family_id": DECODE_FAMILY_ID,
            ...
            {
                "cell_id": "d117-df-cmp-abba-ph-decode-qwen3-8b",
            ...
            {
                "cell_id": "d117-df-ph-prefill-p42-qwen3-8b-absolute",
                "kind": "absolute",
                "metric": "phase_energy_j.prefill",
                "condition_family_id": PREFILL_FAMILY_ID,
                "ordered_bundle_ids": absolute_ids,
            ...
            {
                "cell_id": "d117-df-cmp-abba-ph-prefill-p42-qwen3-8b",
                "kind": "comparative_abba",
                "metric": "phase_energy_j.prefill",
                "condition_family_id": PREFILL_FAMILY_ID,
                "ordered_blocks": canonical_blocks,
    ...
    for stage in stages:
        ...
        for local_index, run in enumerate(stage["runs"], start=1):
            ...
            root_index += 1
        manifest_id = f"d117-floor-qwen3-8b-v5-{stage_id.replace('_', '-')}-order-v1"
        stage_manifest = {
...
def expected_pack_paths() -> list[Path]:
    ...
    paths.extend(
        Path(f"01_phase_decode_absolute/d117fq38-df-ph-decode-abs-r{rep:02d}.json")
    ...
    for block in range(1, 11):
        ...
        paths.extend(
            Path(
                f"{stage}/d117fq38-df-cmp-abba-ph-decode-b{block:02d}-{position}.json"
            )
            for position in ("a1", "b1", "b2", "a2")
        )
    paths.extend(
