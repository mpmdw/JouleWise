...
PACK_REL = Path("configs/campaigns/d117_floor_qwen25_1p5b_v3")
...
CLAIM_ROOT_LEAF = "runs_d117_floor_qwen25_1p5b_v3"
BOUND_ROOT_LEAF = "runs_d117_floor_qwen25_1p5b_v3_bound"
CAMPAIGN_TAG = "d117-floor-qwen25-1p5b-v3"
...
CURRENT_FROZEN_RECEIPT_SHA256 = (
    "1277103b42090f3ce41df0e030a2a5f2a3998598efec12fef812ca5b36b89666"
)
...
_SUCCESSOR_IDENTITY_TOKENS = (
    ...
    "evidence-d117-floor-qwen25-1p5b-v3",
    "plan-set-d117-qwen25-1p5b-7b-phase-floor-v3",
    "d117-qwen25-phase-floor-set-v3",
    "d117-qwen25-1p5b-phase-floor-component-v3",
    "d117-qwen25-1p5b-prefill-p256-floor-v3",
    "d117-qwen25-1p5b-prefill-p128-floor-v3",
    "d117-qwen25-1p5b-decode-floor-v3",
    "tg-d117-qwen25-1p5b-prefill-p256-v3",
    "tg-d117-qwen25-1p5b-prefill-p128-v3",
    "tg-d117-qwen25-1p5b-decode-v3",
...
def build_extraction_spec(
    ...
    order_binding = {
        ...
        "manifest_id": "d117-floor-qwen25-1p5b-v3-order-v1",
...
def build_producer_contract(
    ...
    roles = [
        {
            "role": "decode",
            "artifact_cell_id": "d117-qwen25-1p5b-decode-floor-v3",
            "transport_group_id": "tg-d117-qwen25-1p5b-decode-v3",
            "metric": "phase_energy_j.decode",
            "target_precheck_path": ["phase", "decode"],
        ...
        {
            "role": "prefill",
            "artifact_cell_id": "d117-qwen25-1p5b-prefill-p128-floor-v3",
            "transport_group_id": "tg-d117-qwen25-1p5b-prefill-p128-v3",
            "metric": "phase_energy_j.prefill",
            "target_precheck_path": ["phase", "prefill"],
            "condition_family_id": PREFILL_FAMILY_ID,
        ...
        {
            "role": "prefill_p256",
            "artifact_cell_id": "d117-qwen25-1p5b-prefill-p256-floor-v3",
            "transport_group_id": "tg-d117-qwen25-1p5b-prefill-p256-v3",
            "metric": "phase_energy_j.prefill",
            "target_precheck_path": ["phase", "prefill"],
            "condition_family_id": P256_FAMILY_ID,
    ...
    return {
        ...
        "producer_index": 1,
        "component_artifact_id": "d117-qwen25-1p5b-phase-floor-component-v3",
...
def _generate(output_root: Path) -> tuple[int, str, str]:
    ...
    for stage in stages:
        ...
        for local_index, run in enumerate(stage["runs"], start=1):
            ...
            root_index += 1
        manifest_id = f"d117-floor-qwen25-1p5b-v3-{stage_id.replace('_', '-')}-order-v1"
        stage_manifest = {
