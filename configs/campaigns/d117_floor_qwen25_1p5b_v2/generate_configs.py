...
PACK_REL = Path("configs/campaigns/d117_floor_qwen25_1p5b_v2")
...
CLAIM_ROOT_LEAF = "runs_d117_floor_qwen25_1p5b_v2"
BOUND_ROOT_LEAF = "runs_d117_floor_qwen25_1p5b_v2_bound"
CAMPAIGN_TAG = "d117-floor-qwen25-1p5b-v2"
...
_SUCCESSOR_IDENTITY_TOKENS = (
    ...
    "evidence-d117-floor-qwen25-1p5b-v2",
    "plan-set-d117-qwen25-1p5b-7b-phase-floor-v2",
    "d117-qwen25-phase-floor-set-v2",
    "d117-qwen25-1p5b-phase-floor-component-v2",
    "d117-qwen25-1p5b-prefill-p256-floor-v2",
    "d117-qwen25-1p5b-prefill-p128-floor-v2",
    "d117-qwen25-1p5b-decode-floor-v2",
    "tg-d117-qwen25-1p5b-prefill-p256-v2",
    "tg-d117-qwen25-1p5b-prefill-p128-v2",
    "tg-d117-qwen25-1p5b-decode-v2",
...
def build_extraction_spec(
    ...
    order_binding = {
        ...
        "manifest_id": "d117-floor-qwen25-1p5b-v2-order-v1",
...
def build_producer_contract(
    ...
    roles = [
        {
            "role": "decode",
            "artifact_cell_id": "d117-qwen25-1p5b-decode-floor-v2",
            "transport_group_id": "tg-d117-qwen25-1p5b-decode-v2",
            "metric": "phase_energy_j.decode",
            "target_precheck_path": ["phase", "decode"],
        ...
        {
            "role": "prefill",
            "artifact_cell_id": "d117-qwen25-1p5b-prefill-p128-floor-v2",
            "transport_group_id": "tg-d117-qwen25-1p5b-prefill-p128-v2",
            "metric": "phase_energy_j.prefill",
            "target_precheck_path": ["phase", "prefill"],
            "condition_family_id": PREFILL_FAMILY_ID,
        ...
        {
            "role": "prefill_p256",
            "artifact_cell_id": "d117-qwen25-1p5b-prefill-p256-floor-v2",
            "transport_group_id": "tg-d117-qwen25-1p5b-prefill-p256-v2",
            "metric": "phase_energy_j.prefill",
            "target_precheck_path": ["phase", "prefill"],
            "condition_family_id": P256_FAMILY_ID,
    ...
    return {
        ...
        "producer_index": 1,
        "component_artifact_id": "d117-qwen25-1p5b-phase-floor-component-v2",
...
def _generate(output_root: Path) -> tuple[int, str, str]:
    ...
    for stage in stages:
        ...
        for local_index, run in enumerate(stage["runs"], start=1):
            ...
            root_index += 1
        manifest_id = f"d117-floor-qwen25-1p5b-v2-{stage_id.replace('_', '-')}-order-v1"
        stage_manifest = {
