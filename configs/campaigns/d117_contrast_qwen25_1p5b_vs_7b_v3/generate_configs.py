...
PACK_REL = Path("configs/campaigns/d117_contrast_qwen25_1p5b_vs_7b_v3")
...
PLAN_ID = "plan-d117-contrast-qwen25-1p5b-vs-7b-decode-v3"
EVIDENCE_ROOT_ID = "evidence-d117-contrast-qwen25-1p5b-vs-7b-v3"
CLAIM_ROOT_LEAF = "runs_d117_contrast_qwen25_1p5b_vs_7b_v3"
BOUND_ROOT_LEAF = "runs_d117_contrast_qwen25_1p5b_vs_7b_v3_bound"
N_BLOCKS = 10
MEMBERS_PER_BLOCK = 4
...
_SUCCESSOR_IDENTITY_TOKENS = (
    "plan-d117-contrast-qwen25-1p5b-vs-7b-decode-v3",
    "evidence-d117-contrast-qwen25-1p5b-vs-7b-v3",
    "d117-qwen25-1p5b-vs-7b-gamma-consumer-v3",
    ...
    "d117-contrast-qwen25-1p5b-vs-7b-v3",
)
...
def build_tree(
    ...
    producer_plans = {
        "A": {
            ...
            "path": "../d117_floor_qwen25_1p5b_v3/calibration_plan.json",
        },
        "B": {
            "plan_id": "plan-d117-floor-qwen25-7b-decode-p128-prefill-rider-v3",
            "path": "../d117_floor_qwen25_7b_v3/calibration_plan.json",
        },
    }
...
```text
python3 configs/campaigns/d117_contrast_qwen25_1p5b_vs_7b_v3/generate_configs.py
python3 configs/campaigns/d117_contrast_qwen25_1p5b_vs_7b_v3/generate_configs.py --check
