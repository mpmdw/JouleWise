...
| DG-128 — Appendix A.3.8 retained calibration corpus table, line 1127 | 17 b_fiducial_s bounds (table) | S17#derivation_corpus.members[].b_fiducial_s; `corpus_doubles_from_17_to_34` (`joulewise/calibration_bracketing.py:207`) regenerates both Section 2 constants and this table | diagnostic calibration / n17 | MEASURED | DIAGNOSTIC_ERA / n17 | DRAFT, AUTH |
