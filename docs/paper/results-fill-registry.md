...
unbound, non-default, or refused evidence is `STOP_FILL`, never zero. The
absolute floor component's internal `mean_j` and component count remain
forbidden substitutes.

| Exact token | Producing artifact and output field | Campaign / cell role | Fill rule | Freeze status and resolution | Sources |
|---|---|---|---|---|---|
| `[E_1p7B_prefill_p[PREFILL_LENGTH]_J_per_request]` | Alpha `joulewise.reported_phase_energy.v1` selected cell `cells[].mean_j_per_request`; placement rule `composed_member_envelope_mean.v1` | alpha / prefill-p[PREFILL_LENGTH] reported mean | Render after expected `joulewise.reported_phase_energy_issuance.v1` binding; STOP_FILL on artifact or owning-cell refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; generator-frozen ordered 50-member universe | TPL, AUTH, FX |
| `[E_1p7B_prefill_p[PREFILL_LENGTH]_lower_J]` | Alpha `joulewise.reported_phase_energy.v1` selected cell `cells[].interval.lower_j`; placement rule `composed_member_envelope_mean.v1` | alpha / prefill-p[PREFILL_LENGTH] reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED | TPL, AUTH |
| `[E_1p7B_prefill_p[PREFILL_LENGTH]_upper_J]` | Alpha `joulewise.reported_phase_energy.v1` selected cell `cells[].interval.upper_j`; placement rule `composed_member_envelope_mean.v1` | alpha / prefill-p[PREFILL_LENGTH] reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED | TPL, AUTH |
| `[E_1p7B_prefill_p[PREFILL_LENGTH]_J_per_token]` | Alpha `joulewise.reported_phase_energy.v1` selected cell `cells[].per_token.value_j_per_token`; placement rule `composed_member_envelope_mean.v1` | alpha / prefill-p[PREFILL_LENGTH] reported mean | Ratio of sums over authenticated per-member `runtime_observed`/`server_usage` sources; STOP_FILL on artifact, owning-cell, or denominator-only refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED | TPL, AUTH |
| `[N_bundles_1p7B_prefill_p[PREFILL_LENGTH]]` | Alpha `joulewise.reported_phase_energy.v1` selected cell `cells[].admitted_independent_bundle_count`; placement rule `composed_member_envelope_mean.v1` | alpha / prefill-p[PREFILL_LENGTH] reported mean | Render the issued fixed-universe count; STOP_FILL on artifact or owning-cell refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; never a floor-component count | TPL, AUTH, FX |
| `[E_1p7B_decode_J_per_request]` | Alpha `joulewise.reported_phase_energy.v1` decode cell `cells[].mean_j_per_request`; placement rule `composed_member_envelope_mean.v1` | alpha / decode reported mean | Render after expected `joulewise.reported_phase_energy_issuance.v1` binding; STOP_FILL on artifact or owning-cell refusal | VALUE_UNISSUED; generator-frozen ordered 50-member universe | TPL, AUTH, FX |
| `[E_1p7B_decode_lower_J]` | Alpha `joulewise.reported_phase_energy.v1` decode cell `cells[].interval.lower_j`; placement rule `composed_member_envelope_mean.v1` | alpha / decode reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | VALUE_UNISSUED | TPL, AUTH |
| `[E_1p7B_decode_upper_J]` | Alpha `joulewise.reported_phase_energy.v1` decode cell `cells[].interval.upper_j`; placement rule `composed_member_envelope_mean.v1` | alpha / decode reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | VALUE_UNISSUED | TPL, AUTH |
| `[E_1p7B_decode_J_per_token]` | Alpha `joulewise.reported_phase_energy.v1` decode cell `cells[].per_token.value_j_per_token`; placement rule `composed_member_envelope_mean.v1` | alpha / decode reported mean | Ratio of sums over authenticated per-member `runtime_observed`/`server_usage` sources, each fixed to 512 output tokens; STOP_FILL on artifact, owning-cell, or denominator-only refusal | VALUE_UNISSUED | TPL, AUTH |
| `[N_bundles_1p7B_decode]` | Alpha `joulewise.reported_phase_energy.v1` decode cell `cells[].admitted_independent_bundle_count`; placement rule `composed_member_envelope_mean.v1` | alpha / decode reported mean | Render the issued fixed-universe count; STOP_FILL on artifact or owning-cell refusal | VALUE_UNISSUED; never a floor-component count | TPL, AUTH, FX |
| `[E_8B_prefill_p[PREFILL_LENGTH]_J_per_request]` | Beta `joulewise.reported_phase_energy.v1` selected cell `cells[].mean_j_per_request`; placement rule `composed_member_envelope_mean.v1` | beta / prefill-p[PREFILL_LENGTH] reported mean | Render after expected `joulewise.reported_phase_energy_issuance.v1` binding; STOP_FILL on artifact or owning-cell refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; generator-frozen ordered 50-member universe | TPL, AUTH, FX |
| `[E_8B_prefill_p[PREFILL_LENGTH]_lower_J]` | Beta `joulewise.reported_phase_energy.v1` selected cell `cells[].interval.lower_j`; placement rule `composed_member_envelope_mean.v1` | beta / prefill-p[PREFILL_LENGTH] reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED | TPL, AUTH |
| `[E_8B_prefill_p[PREFILL_LENGTH]_upper_J]` | Beta `joulewise.reported_phase_energy.v1` selected cell `cells[].interval.upper_j`; placement rule `composed_member_envelope_mean.v1` | beta / prefill-p[PREFILL_LENGTH] reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED | TPL, AUTH |
| `[E_8B_prefill_p[PREFILL_LENGTH]_J_per_token]` | Beta `joulewise.reported_phase_energy.v1` selected cell `cells[].per_token.value_j_per_token`; placement rule `composed_member_envelope_mean.v1` | beta / prefill-p[PREFILL_LENGTH] reported mean | Ratio of sums over authenticated per-member `runtime_observed`/`server_usage` sources; STOP_FILL on artifact, owning-cell, or denominator-only refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED | TPL, AUTH |
| `[N_bundles_8B_prefill_p[PREFILL_LENGTH]]` | Beta `joulewise.reported_phase_energy.v1` selected cell `cells[].admitted_independent_bundle_count`; placement rule `composed_member_envelope_mean.v1` | beta / prefill-p[PREFILL_LENGTH] reported mean | Render the issued fixed-universe count; STOP_FILL on artifact or owning-cell refusal | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; never a floor-component count | TPL, AUTH, FX |
| `[E_8B_decode_J_per_request]` | Beta `joulewise.reported_phase_energy.v1` decode cell `cells[].mean_j_per_request`; placement rule `composed_member_envelope_mean.v1` | beta / decode reported mean | Render after expected `joulewise.reported_phase_energy_issuance.v1` binding; STOP_FILL on artifact or owning-cell refusal | VALUE_UNISSUED; generator-frozen ordered 50-member universe | TPL, AUTH, FX |
| `[E_8B_decode_lower_J]` | Beta `joulewise.reported_phase_energy.v1` decode cell `cells[].interval.lower_j`; placement rule `composed_member_envelope_mean.v1` | beta / decode reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | VALUE_UNISSUED | TPL, AUTH |
| `[E_8B_decode_upper_J]` | Beta `joulewise.reported_phase_energy.v1` decode cell `cells[].interval.upper_j`; placement rule `composed_member_envelope_mean.v1` | beta / decode reported-mean interval | Render only with the same issued cell; STOP_FILL on artifact, owning-cell, or rule refusal | VALUE_UNISSUED | TPL, AUTH |
| `[E_8B_decode_J_per_token]` | Beta `joulewise.reported_phase_energy.v1` decode cell `cells[].per_token.value_j_per_token`; placement rule `composed_member_envelope_mean.v1` | beta / decode reported mean | Ratio of sums over authenticated per-member `runtime_observed`/`server_usage` sources, each fixed to 512 output tokens; STOP_FILL on artifact, owning-cell, or denominator-only refusal | VALUE_UNISSUED | TPL, AUTH |
| `[N_bundles_8B_decode]` | Beta `joulewise.reported_phase_energy.v1` decode cell `cells[].admitted_independent_bundle_count`; placement rule `composed_member_envelope_mean.v1` | beta / decode reported mean | Render the issued fixed-universe count; STOP_FILL on artifact or owning-cell refusal | VALUE_UNISSUED; never a floor-component count | TPL, AUTH, FX |
...
| DS-09 — Table 2 prompt/1.5B gross cell, line 280, col 3 under `Gross J/request (lower, upper)` | `[PENDING]`; row anchor `\| prompt processing \| 1.5B \|` | Alpha `joulewise.reported_phase_energy.v1` exact selected prefill cell `mean_j_per_request` with `interval.{lower_j,upper_j}` under default `composed_member_envelope_mean.v1` | alpha / prefill-p[PREFILL_LENGTH] reported mean | MEASURED | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; generator-frozen ordered 50-member universe | DRAFT, TPL, AUTH, V5GEN |
| DS-10 — Table 2 prompt/1.5B per-token cell, line 280, col 4 under `J per prompt token` | `[PENDING]`; row anchor `\| prompt processing \| 1.5B \|` | Same cell `per_token.value_j_per_token`, ratio of sums with authenticated runtime-observed or `server_usage` prompt denominator | alpha / prefill-p[PREFILL_LENGTH] reported mean | MEASURED | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; denominator-only refusal does not suppress authenticated gross/count fields | DRAFT, TPL, AUTH, V5GEN |
...
| DS-12 — Table 2 prompt/1.5B count cell, line 280, col 7 under `n` | `[PENDING]`; row anchor `\| prompt processing \| 1.5B \|` | Same cell `admitted_independent_bundle_count` | alpha / prefill-p[PREFILL_LENGTH] reported mean | MEASURED | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; count the generator-frozen ordered 50-member universe, never floor components | DRAFT, TPL, AUTH, V5GEN |
| DS-13 — Table 2 prompt/7B gross cell, line 281, col 3 under `Gross J/request (lower, upper)` | `[PENDING]`; row anchor `\| prompt processing \| 7B \|` | Beta `joulewise.reported_phase_energy.v1` exact selected prefill cell `mean_j_per_request` with `interval.{lower_j,upper_j}` under default `composed_member_envelope_mean.v1` | beta / prefill-p[PREFILL_LENGTH] reported mean | MEASURED | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; generator-frozen ordered 50-member universe | DRAFT, TPL, AUTH, V5GEN |
| DS-14 — Table 2 prompt/7B per-token cell, line 281, col 4 under `J per prompt token` | `[PENDING]`; row anchor `\| prompt processing \| 7B \|` | Same cell `per_token.value_j_per_token`, ratio of sums with authenticated runtime-observed or `server_usage` prompt denominator | beta / prefill-p[PREFILL_LENGTH] reported mean | MEASURED | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; denominator-only refusal does not suppress authenticated gross/count fields | DRAFT, TPL, AUTH, V5GEN |
...
| DS-16 — Table 2 prompt/7B count cell, line 281, col 7 under `n` | `[PENDING]`; row anchor `\| prompt processing \| 7B \|` | Same cell `admitted_independent_bundle_count` | beta / prefill-p[PREFILL_LENGTH] reported mean | MEASURED | UNRESOLVED-UNTIL-G2A / VALUE_UNISSUED; count the generator-frozen ordered 50-member universe, never floor components | DRAFT, TPL, AUTH, V5GEN |
| DS-17 — Table 2 decode/1.5B gross cell, line 282, col 3 under `Gross J/request (lower, upper)` | `[PENDING]`; row anchor `\| token generation \| 1.5B \|` | Alpha `joulewise.reported_phase_energy.v1` exact decode cell `mean_j_per_request` with `interval.{lower_j,upper_j}` under default `composed_member_envelope_mean.v1` | alpha / decode reported mean | MEASURED | KEY_FROZEN / VALUE_UNISSUED; generator-frozen ordered 50-member universe | DRAFT, TPL, AUTH, V5GEN |
| DS-18 — Table 2 decode/1.5B per-token cell, line 282, col 5 under `J per output token` | `[PENDING]`; row anchor `\| token generation \| 1.5B \|` | Same cell `per_token.value_j_per_token`, ratio of sums with authenticated runtime-observed or `server_usage` output denominator fixed to 512 per member | alpha / decode reported mean | MEASURED | KEY_FROZEN / VALUE_UNISSUED; denominator-only refusal does not suppress authenticated gross/count fields | DRAFT, TPL, AUTH, V5GEN |
...
| DS-20 — Table 2 decode/1.5B count cell, line 282, col 7 under `n` | `[PENDING]`; row anchor `\| token generation \| 1.5B \|` | Same cell `admitted_independent_bundle_count` | alpha / decode reported mean | MEASURED | KEY_FROZEN / VALUE_UNISSUED; count the generator-frozen ordered 50-member universe, never floor components | DRAFT, TPL, AUTH, V5GEN |
| DS-21 — Table 2 decode/7B gross cell, line 283, col 3 under `Gross J/request (lower, upper)` | `[PENDING]`; row anchor `\| token generation \| 7B \|` | Beta `joulewise.reported_phase_energy.v1` exact decode cell `mean_j_per_request` with `interval.{lower_j,upper_j}` under default `composed_member_envelope_mean.v1` | beta / decode reported mean | MEASURED | KEY_FROZEN / VALUE_UNISSUED; generator-frozen ordered 50-member universe | DRAFT, TPL, AUTH, V5GEN |
| DS-22 — Table 2 decode/7B per-token cell, line 283, col 5 under `J per output token` | `[PENDING]`; row anchor `\| token generation \| 7B \|` | Same cell `per_token.value_j_per_token`, ratio of sums with authenticated runtime-observed or `server_usage` output denominator fixed to 512 per member | beta / decode reported mean | MEASURED | KEY_FROZEN / VALUE_UNISSUED; denominator-only refusal does not suppress authenticated gross/count fields | DRAFT, TPL, AUTH, V5GEN |
...
| DS-24 — Table 2 decode/7B count cell, line 283, col 7 under `n` | `[PENDING]`; row anchor `\| token generation \| 7B \|` | Same cell `admitted_independent_bundle_count` | beta / decode reported mean | MEASURED | KEY_FROZEN / VALUE_UNISSUED; count the generator-frozen ordered 50-member universe, never floor components | DRAFT, TPL, AUTH, V5GEN |
...
| DS-28 — Table 3 decode sizing sum and signed clearance, line 289, col 5 under `Sizing sum F+B; signed clearance` | `[PENDING]`; row anchor `\| token generation, 7B − 1.5B \|` | `C_decode_floor_clearance_J` on passage or negative of `S_decode_floor_shortfall_J` on refusal; branch must be explicit | gamma / decode contrast | DERIVE | DRAFT/TEMPLATE SHAPE MISMATCH; draft has one unconditional cell | DRAFT, TPL |
...
| D-123 reported means | RESOLVED AS TO CONTRACT: R1 and `joulewise.reported_phase_energy.v1` fix the generator-frozen member basis, fields, default composition rule, three refusal levels, and expected issuance binding | Keep values `VALUE_UNISSUED` until the authenticated alpha/beta artifacts and governed issuance manifest exist; retain the byte-identical floor regression | AUTH, FX, PLAN |
...
- Keep the ruled D-123 source/artifact/issuance chain synchronized with all 20
  exact-token rows; no token is fillable until its expected issuance digest and
  authenticated alpha/beta artifact exist.
