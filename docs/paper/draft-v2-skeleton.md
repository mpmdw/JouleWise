...
| set membership | 11. References | built-before | Section 8 builds bounded systematic uncertainty before the Milanese–Vicino title names the framework; Appendix A.3 gives the exact set of anchor-rate pairs consistent with every evidence constraint. |
