...
current 9.724-ms bracket screen in its named renderings; keep `DG-063` retired
and absent from the draft; distinguish the superseded and current corpus counts
