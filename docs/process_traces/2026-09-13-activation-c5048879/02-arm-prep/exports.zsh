...
set -euo pipefail
export BOOKKEEPING_ROOT=/Users/edr/code/JouleWise-wt-bk-c5048879
export H="${H:-$(cat /tmp/magistrate-c5048879/H.txt)}"
...
export TRACE_DIR="$BOOKKEEPING_ROOT/docs/process_traces/2026-09-13-activation-c5048879"
