...
def fixture_directory():
    ...
    while True:
        temp=tempfile.TemporaryDirectory(prefix='qpe01-arm-fixture-',dir=HERE)
...
def main():
    ...
    assert arm_head == head == '980f8d6452fb6923644bdac1e243ce0a344c881f'
    print('PASS arm pin and fixture HEAD equal H4 980f8d6452fb6923644bdac1e243ce0a344c881f')
    # Every mutation below stays in the authorized scripts directory.
    with fixture_directory() as td:
        temp=Path(td).resolve()
        assert temp.is_relative_to(HERE)
