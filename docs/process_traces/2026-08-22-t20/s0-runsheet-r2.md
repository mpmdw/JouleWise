...
- [ ] **S0-BLOCKED addendum** — all 21 exact methods in §5.1 are ordinary PASS (zero expected failures and zero unexpected successes) against the minted `_v4` fixture in the clone. Authority: S-1 MANIFEST §§9.3 and 9.3.5.
...
### 5.1 S0-BLOCKED set — 21 exact methods that must flip green
