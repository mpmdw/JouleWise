...
print("DRAFT — DO NOT SEND: the recipe promises no Git operations. The pinned program actually uses read-only Git commands to verify its input bytes before capture. The lead must resolve that conflict before approving this notice.")
