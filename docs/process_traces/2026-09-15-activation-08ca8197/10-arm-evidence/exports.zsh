# Staging/arm exports for the REHEARSAL_STUB rehearsal-20260916 (activation 08ca8197), re-cut at the handback commit H.
set -euo pipefail
...
export MEASUREMENT_ROOT="/Users/edr/JouleWise-measurement-rehearsal-${NIGHT_DATE}b"
...
export T0_EPOCH_S=1789552800   # 2026-09-16 03:00:00 PDT, fixed in the handback commit H
