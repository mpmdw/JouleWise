...
print -- "EXIT RULE: magistrate and all owned agents must exit BEFORE T0 - 480 = $(date -r $((T0_EPOCH_S - 480)) '+%Y-%m-%d %H:%M:%S %Z') ($(TZ=UTC date -r $((T0_EPOCH_S - 480)) '+%Y-%m-%d %H:%M:%S UTC'); epoch $((T0_EPOCH_S - 480)))."
