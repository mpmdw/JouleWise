...
## Exhibit map (source path → exhibit file in this directory)

The charge cites repository paths. The judge reads the exhibit file named here, which is a byte copy pinned by the manifest.

| Source path | Exhibit |
|---|---|
| `docs/process_traces/2026-09-24-activation-a65fb4fa/07b-a282-ap5m-draft-v2.md` | `ex-a65-07b-a282-ap5m-draft-v2.md` |
| `docs/process_traces/2026-09-24-activation-a65fb4fa/07-a282-ap5m-draft.md` | `ex-a65-07-a282-ap5m-draft.md` |
| `docs/process_traces/2026-09-24-activation-a65fb4fa/11-a282-fidelity-sol-lens.md` | `ex-a65-11-a282-fidelity-sol-lens.md` |
| `docs/process_traces/2026-09-24-activation-a65fb4fa/12-a282-pedagogy-opus-lens.md` | `ex-a65-12-a282-pedagogy-opus-lens.md` |
| `docs/process_traces/2026-09-24-activation-a65fb4fa/16-a282-v2-fidelity-delta-brief.md` | `ex-a65-16-a282-v2-fidelity-delta-brief.md` |
| `docs/process_traces/2026-09-24-activation-a65fb4fa/17-a282-v2-fidelity-delta.md` | `ex-a65-17-a282-v2-fidelity-delta.md` |
| `docs/process_traces/2026-09-24-activation-a65fb4fa/18-a282-v2-pedagogy-delta.md` | `ex-a65-18-a282-v2-pedagogy-delta.md` |
| `docs/process_traces/2026-09-23-activation-1d3796d5/09-headline-packet-b-scored-night.md` | `ex-1d37-09-headline-packet-b-scored-night.md` |
| `docs/process_traces/2026-09-23-activation-1d3796d5/10-headline-packet-c-ap5-amendment.md` | `ex-1d37-10-headline-packet-c-ap5-amendment.md` |
| `docs/process_traces/2026-09-23-activation-1d3796d5/18-headline-opus-integration.md` | `ex-1d37-18-headline-opus-integration.md` |
| `docs/process_traces/2026-09-23-activation-1d3796d5/19-headline-integration-synthesis.md` | `ex-1d37-19-headline-integration-synthesis.md` |
| `docs/process_traces/2026-09-23-activation-1d3796d5/40-fable-ruling-math.md` | `ex-1d37-40-fable-ruling-math.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/08-a281-round1-synthesis-and-rulings.md` | `ex-d8cc-08-a281-round1-synthesis-and-rulings.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/20-a281-opus-consult.md` | `ex-d8cc-20-a281-opus-consult.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/21-coldgate-packet-a281/00-charge.md` | `ex-d8cc-21-coldgate-packet-a281-00-charge.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/21-coldgate-packet-a281/10-coldgate-fable-ruling.md` | `ex-d8cc-21-coldgate-packet-a281-10-coldgate-fable-ruling.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/21-coldgate-packet-a281/11-opus-contract-refuter.md` | `ex-d8cc-21-coldgate-packet-a281-11-opus-contract-refuter.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/45-coldgate-packet-a281a-recut/10-coldgate-fable-ruling.md` | `ex-d8cc-45-coldgate-packet-a281a-recut-10-coldgate-fable-ruling.md` |
| `docs/process_traces/2026-09-23-activation-d8cc9c0a/45-coldgate-packet-a281a-recut/21-coldgate-fable-addendum-ruling.md` | `ex-d8cc-45-coldgate-packet-a281a-recut-21-coldgate-fable-addendum-ruling.md` |
| `docs/contracts/analysis_plans.md` | `ex-repo-docs-contracts-analysis_plans.md` |
| `docs/phase_2/detection_floor.md` | `ex-repo-docs-phase_2-detection_floor.md` |
| `docs/decision_log.md` | `ex-repo-docs-decision_log.md` |
| `docs/phase_2/suite_implementation_research.md` | `ex-repo-docs-phase_2-suite_implementation_research.md` |
| `docs/research_question_bank.md` | `ex-repo-docs-research_question_bank.md` |
| `docs/paper/artifact-guide.md` | `ex-repo-docs-paper-artifact-guide.md` |
| `joulewise/benchmark_import_math.py` | `ex-repo-joulewise-benchmark_import_math.py` |

## Constraints on the judge

Read-only; nothing armed. Never run `sudo`, `launchctl`, `powermetrics` or `systemsetup`. Never touch `/Users/edr/code/JouleWise` (canonical root), `/Users/edr/night-custody`, any `/Users/edr/JouleWise-measurement-*`, or `~/Library/LaunchAgents`. Write only the ruling file. Read the exhibits in this packet directory; do not read any other `docs/process_traces` file, or RUN_STATE.md, TASK_QUEUE.md, council logs, run reports or memory. The ruling binds the NEXT DRAFT's text; claim policy is adopted only by Ed.
