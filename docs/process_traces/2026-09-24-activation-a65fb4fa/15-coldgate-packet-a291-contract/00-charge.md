...
Convened 2026-09-24 by the resident magistrate (Opus 5.5, activation a65fb4fa). Nothing is armed. The Opus and Sol picks and the magistrate's proposed dispositions are ARGUMENT, not authority. The ruling file is `10-coldgate-fable-ruling.md` in this directory.
...
Every source is an exhibit file in this packet directory (the manifest below pins its digest). The judge reads only this directory, plus the stopped code at git commit `c0998fdb` (`git show c0998fdb:<path>`).

| Key | Exhibit file |
|---|---|
| [08] | `ex-08-round1-rulings.md` |
| [21/10] | `ex-21-10-coldgate-ruling.md` |
| [21/11] | `ex-21-11-opus-refuter.md` |
| [45/10] | `ex-45-10-coldgate-ruling.md` |
| [45/11] | `ex-45-11-opus-refuter.md` |
| [45/21] | `ex-45-21-addendum-ruling.md` |
| [B26] | `ex-B26-a281a-fix2-seat-brief.md` |
| [19] | `ex-19-headline-integration-synthesis.md` |
| [09] | `ex-09-sol-contract-lens.md` |
| [13] | `ex-13-magistrate-synthesis.md` |
| [02] | `ex-02-contract-v1.md` (the first draft) |
| [02b] | `ex-02b-contract-v2.md` (the proposed contract; its `PENDING-GATE(OP-nn)` rows are decided here) |
...
Read-only; nothing armed. Never run `sudo`, `launchctl`, `powermetrics` or `systemsetup`. Never touch `/Users/edr/code/JouleWise` (canonical root), `/Users/edr/night-custody`, any `/Users/edr/JouleWise-measurement-*`, or `~/Library/LaunchAgents`. Probes run only in a `git archive c0998fdb` copy under `/tmp`. Write only the ruling file. Do not read any `docs/process_traces` file outside this packet directory, and do not read RUN_STATE.md, TASK_QUEUE.md, council logs, run reports or memory.
...
```
cda471d65cf2ca7a4c67941f9f7fb75552d085c6c34b4cf364edd546ad2c7d42  ex-02-contract-v1.md
...
978d52d7132895321c6c7c182c4e7f996f0426b41caa1060aeac958b16ee16c4  ex-09-sol-contract-lens.md
34f8e9d820b87047543287057db332f68961395b0afa8cf5627df9a33b7347d4  ex-13-magistrate-synthesis.md
5134d0d89cc239c1c4972967e0a2c620cb55c387b521e222e5c70eb43d966104  ex-19-headline-integration-synthesis.md
b8a66c41a1ede0e8df065956c176b2c86f2260110daf449853b3a13269050e2d  ex-21-10-coldgate-ruling.md
02c55d4e5c135e90172deff0ca3307b0fa06dfa1267358716f0943b8ce88d2e0  ex-21-11-opus-refuter.md
9fc61ee0765f37516580c1c8972b85638d61e1333a420691f9b30dd214d38b7a  ex-45-10-coldgate-ruling.md
b180005aa7ea17fa5654e0537cf1f3d4e4bad4471d67208d61e5d42db966deaf  ex-45-11-opus-refuter.md
005c0c96ffe54885fbb0e4f37a6b2b25bea76f245d5e39dfae87ac9667ebfc84  ex-45-21-addendum-ruling.md
eb545ff1d46f55c71631c1a59976e6aea1ac162ded2d2b555150b25981d83f2c  ex-B26-a281a-fix2-seat-brief.md
```
