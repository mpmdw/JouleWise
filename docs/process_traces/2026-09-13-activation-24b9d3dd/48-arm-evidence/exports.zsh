# Sourced by every later block. H is read from H.txt (origin/main after the handback commit).
set -euo pipefail
export BOOKKEEPING_ROOT=/Users/edr/code/JouleWise-wt-bk-24b9d3dd
export H="${H:-$(cat /tmp/magistrate-24b9d3dd/arm/H.txt)}"
export NIGHT_DATE=20260915
...
export T0_EPOCH_S=1789466160   # 2026-09-15T02:56:00-07:00
export WINDOW_MAX_S=9000
export NIGHT_HOUR=2 NIGHT_MINUTE=56
export TRACE_DIR="$BOOKKEEPING_ROOT/docs/process_traces/2026-09-13-activation-24b9d3dd"
export EVIDENCE_DIR="$TRACE_DIR/48-arm-evidence"
