...
(`docs/process_traces/2026-08-27-t26/WAVE-ROWS.md`): S9-04 is
...
```text
$ git show 10845c14:docs/process/state_kernel.json > $S/tmp235/kernel-10845c14.json
$ python3 - <<'PY'   # census of rows whose JSON cites an S9-nn label, kernel at 10845c14
import json,re
k=json.load(open('$S/tmp235/kernel-10845c14.json'))
print(len(k['tasks']))
