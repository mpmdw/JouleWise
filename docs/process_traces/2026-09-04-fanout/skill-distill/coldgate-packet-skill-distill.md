...
`ef06b4c7b8f38f71adb1e4b35acd36c0dcce933b`. The comparison base is the
...
candidate delta, not the superseded intermediate wording. Exhibits 06 and 07
preserve that wording and its fix history.
...
No skill file changes. The other four changed paths are custody rather than
doctrine: the seat report, lesson record, refuter report, and fix report in
exhibits 01–04. Exhibit 05 is the complete computed-base delta; exhibits 06–07
are the original implementation and fix deltas. Exhibits 08–11 are verbatim
before/after copies of both rule-bearing files. Exhibits 12–25 are verbatim
authority or incident-evidence copies. All line citations below refer to those
copies.
...
**After (exact, exhibit 09:481–490):**
...
**After (exact, exhibit 09:492–498):**
...
**After (exact, exhibit 11:356–360):**
...
**After (exact, exhibit 11:364–373):**
...
**After (exact, exhibit 11:375–386):**
...
**After (exact, exhibit 11:388–393):**
...
**After (exact, exhibit 11:397–406):**
...
**After (exact, exhibit 11:410–420):**
...
**After (exact, exhibit 11:422–427):**
...
**After (exact, exhibit 11:431–433):**
...
**After (exact, exhibit 11:433–442, beginning after “mandatory.”):**
...
Read the charter first, then exhibits 08–12 and the two candidate deltas before
the seat/refuter/fix reports. Keep Q1–Q11 independent. Do not write, run tests,
start agents, use network commands, or inspect another seat's scratch. Treat the
validator receipt only as validation-time byte observation, never as judge
handoff or launch authorization.
...
e6540629b72e69cf8ac5349370cddf5ad387e3f0f72c89881f022a962dd2714b  packet-exhibits/05-delta-merge-base-to-head.patch
