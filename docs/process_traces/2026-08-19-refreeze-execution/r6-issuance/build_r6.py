#!/usr/bin/env python3
"""Assemble the science-neutral D-079 r6 capture-presentation reissue.

This follows the r3/r4/r5 issuance builders.  It authenticates r5, updates only
...
if len(sys.argv) != 2:
    raise SystemExit("usage: build_r6.py REPOSITORY_ROOT")
...
PREDECESSOR_ID = "d079_calibration_acceptance_v2_n17_r5"
PREDECESSOR_REL = "configs/calibration/calibration_acceptance_d079_v2_n17_r5.json"
ACCEPTANCE_ID = "d079_calibration_acceptance_v2_n17_r6"
OUTPUT_REL = "configs/calibration/calibration_acceptance_d079_v2_n17_r6.json"
...
def main() -> int:
    ...
    if not changed:
        print("REFUSE no estimator pin moved; r6 would duplicate r5")
        return 2
    expected_changed = {
    ...
    if set(changed) != expected_changed:
        print(
            "REFUSE r6 moved pins must be exactly "
    ...
    artifact["derivation_notes"]["generation"] = (
        "SCIENCE-NEUTRAL reissue of d079_calibration_acceptance_v2_n17_r5 at the "
        "capture-pipeline presentation and calibration-capture-time taxonomy head. "
        "Only governed estimator bytes rotated; the full "
    ...
    artifact["derivation_notes"]["predecessor"] = {
        ...
        "relationship": (
            ...
            "generation; r6 supersedes r5 only as the LIVE generation and "
    ...
    artifact["derivation_notes"]["reissue_delta"] = {
        ...
        "science_neutrality_evidence": (
            ...
            "rederive_detection_from_artifacts at the capture-presentation head; every "
