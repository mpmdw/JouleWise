...
| 2K NVIDIA/vLLM/ssh | conditional (gate: P1-006 NVIDIA evidence) | pending live promotion; CODE-NOW NV-GATE-2 units implemented 2026-07-10 on `impl/nvgate2-codenow` | remote bundle from 3050, or documented access blocker | CODE-NOW evidence `docs/run_reports/2026-07-10-nvgate2-codenow.md`; live rows 16–20 and PROVISIONAL-pin exit remain open; applicability table + spec in `hardware_slice_implementation_guide.md` |
