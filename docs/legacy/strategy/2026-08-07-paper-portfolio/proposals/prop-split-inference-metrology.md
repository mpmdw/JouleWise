...
session id: 019fdd0c-cbb4-7e32-b6b5-0a8a57261097
--------
user
...
== YOUR ASSIGNED DIRECTION (split-inference-metrology) ==
Split/disaggregated inference across two consumer devices (M3 Max + 3080 Ti rig): two-boundary metrology, transfer-interval energy accounting, cross-device clock alignment — the measurement-method paper for split inference. (Original split goal; wall meter likely needed.)

codex
I’ll treat this as a read-only proposal task. I’m going to read every required source in full, then ground the split-inference extension in the frozen D-117 path and explicitly shrink or kill any part that the existing instrument cannot support.
exec
/bin/zsh -lc 'git status --short --branch && wc -l docs/paper/draft-v1.md CLAIMS_STATUS.md docs/decision_log.md docs/process_traces/2026-08-07-d117-plan-freeze/DESIGN-MEMO.md docs/strategy/2026-08-06-impressiveness-roadmap.md docs/research_question_registry.md docs/research_question_bank.md docs/process_traces/2026-08-07-prefill-feasibility/SYNTHESIS.md RUN_STATE.md TASK_QUEUE.md docs/agent_playbook.md docs/orchestration.md' in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
## main...origin/main
...
exec
/bin/zsh -lc "sed -n '1,260p' docs/paper/draft-v1.md && sed -n '1,240p' CLAIMS_STATUS.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '1,520p' docs/process_traces/2026-08-07-d117-plan-freeze/DESIGN-MEMO.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
```json
{
...
exec
/bin/zsh -lc "sed -n '1,550p' docs/research_question_bank.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
exec
/bin/zsh -lc "sed -n '1,260p' docs/strategy/2026-08-06-impressiveness-roadmap.md && sed -n '1,200p' docs/research_question_registry.md && sed -n '1,100p' docs/process_traces/2026-08-07-prefill-feasibility/SYNTHESIS.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '551,1150p' docs/research_question_bank.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
...
codex
The first pass confirms the decisive constraint: D-117’s three windows are the paper’s irreducible claim path, and any split study must be additive rather than a substitute. I’m now extracting the exact budgets, estimands, and prior split-related diagnostics before sizing extra nights.
exec
...
exec
/bin/zsh -lc "sed -n '251,520p' docs/process_traces/2026-08-07-d117-plan-freeze/DESIGN-MEMO.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
| Absolute floor | 10 | `abs-r01` through `abs-r10` |
| Null half 1 | 20 | ABBA blocks 1–5 |
| Midpoint reference | 1 | Frozen midpoint |
...
exec
/bin/zsh -lc "sed -n '101,194p' docs/paper/draft-v1.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
\]
...
exec
/bin/zsh -lc "sed -n '1,95p' CLAIMS_STATUS.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
# Claims Status
...
exec
/bin/zsh -lc "sed -n '96,190p' CLAIMS_STATUS.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
  clean 1/1, frozen corpus verified byte-identical (210+4 files, zero
  mismatches). The governed re-evaluation then REFUSED pre-verdict:
  survivor consumption failed on `mtadd-p2048o0128-r06`'s
...
exec
/bin/zsh -lc "sed -n '1,125p' docs/process_traces/2026-08-07-d117-plan-freeze/DESIGN-MEMO.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
```json
{
  "schema": "claude-codex-report/v1",
...
exec
/bin/zsh -lc "sed -n '126,250p' docs/process_traces/2026-08-07-d117-plan-freeze/DESIGN-MEMO.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'rg -n -i "split|disaggreg|transfer|clock|3080|wall meter|WT310|two.boundar|P1-00[34]|C5-2.[348]" docs/research_question_registry.md docs/research_question_bank.md docs/strategy/2026-08-06-impressiveness-roadmap.md | head -n 240' in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
docs/strategy/2026-08-06-impressiveness-roadmap.md:24:        "detail": "D-110 still withholds the floor and contrast artifacts pending issuance/remint, while D-113 requires fresh Window C collection, prospectively split into D if needed."
...
docs/strategy/2026-08-06-impressiveness-roadmap.md:108:The instrument and its evidence machinery are unusually mature, but the paper still lacks a complete claim-bearing characterization result. The 1.5B/7B contrast passed collection gates and is a compelling preliminary demonstration, yet D-110 prevents formal use until the issuance/remint chain completes. D-113 then requires fresh Window C collection—split into D if necessary—without importing any retired Window B member. See [D-113](/Users/edr/code/JouleWise/docs/decision_log.md:7240) and the [current paper outline](/Users/edr/code/JouleWise/docs/run_reports/2026-07-30-paper-outline-v1.md:1).
docs/strategy/2026-08-06-impressiveness-roadmap.md:117:- Weakening calibration, whole-window, clock, or custody gates for schedule reasons.
docs/strategy/2026-08-06-impressiveness-roadmap.md:156:| **1** | **Complete C1–C7 cleanly: remint, fresh C/D, and stability** | Converts the strongest idea—the instrument and its refusal behavior—into actual evidence. This is the difference between an elaborate methodology and a metrology paper. | **3–6 weeks after desk gates; 2 mandatory nights plus 1 contingency/short stability session.** | D-079 issued artifact; D-110 remint; reviewed frozen-plan record; fresh §5A; C/D split if scope cannot fit. Risk: another environmental or clock refusal. | Reserve the core nights now and prohibit breadth work from consuming them. |
docs/strategy/2026-08-06-impressiveness-roadmap.md:161:| **6** | **Second-unit replication after multi-day same-unit stability** | This is the clearest path beyond single-machine claims and toward L4. It demonstrates that the artifact and calibration method transfer, not merely that one laptop is stable. | **4–8 weeks once access exists; 2 sessions on the second unit, 0–2 Ed-present depending on operator.** | A second comparable Apple unit, frozen stack or explicitly modeled version difference, independent calibration and artifact execution. Risk: OS/hardware drift may make it replication-aware rather than directly pooled. | Secure a second unit/collaborator or explicitly retain the single-unit ceiling. |
...
docs/strategy/2026-08-06-impressiveness-roadmap.md:172:| **CSCSU** | After remint and clean C/D, this should be a strong undergraduate-conference submission. The latest published rules allow technical papers and extensive experimentation, with **5 pages including references**. [CSCSU 2026 guidance](https://cscsu-conference.github.io/) | C1–C6 core, one demonstration, crisp limitations, compact artifact pointer. Wall validation and split are not necessary. |
...
docs/strategy/2026-08-06-impressiveness-roadmap.md:191:The strongest realistic paper is therefore: **C1–C8 metrology + the already-collected 1.5B/7B demonstration + one designed extension + an independently usable artifact.** That is more coherent and defensible than a larger model/device matrix or an unfinished split system.
...
docs/strategy/2026-08-06-impressiveness-roadmap.md:207:The methods draft was inspected from `impl/paper-draft-v1` at commit `af0b7195`; it is one commit ahead of and one commit behind `main`. It already reflects the right rigor: result placeholders remain pending remint, all characterization rows are pending Window C, and the split section is framed as future demonstration work. It should be integrated deliberately so the paper itself becomes the continuously updated claim-state surface.
docs/research_question_registry.md:13:kills, quarantines, and amendments. Single-writer split: update this registry
...
docs/research_question_registry.md:94:| C5-2.9 | Local-vs-datacenter crossover economics | research question | candidate | scenario result only | no measured-equivalent cloud comparison | none-yet | P1-003 plus P1-004 | hardware | analysis-plan-only | Surviving scenario form of the carbon-label kill. |
...
docs/research_question_registry.md:114:| APP-CARBON-LABELS | Carbon labels | application idea | killed | none | no carbon label without wall meter and grid assumptions | none-yet | none | hardware | no | Killed as product label; C5-2.9 is the surviving scenario question. |
docs/research_question_bank.md:19:  devices and enables compositional split-energy prediction (predict
docs/research_question_bank.md:20:  split-run energy from monolithic coefficients + transfer measurements,
docs/research_question_bank.md:30:  platform rails vs AC wall power? (Gated on the wall meter, P1-003/R-007;
docs/research_question_bank.md:48:  compute-bound prefill and memory-bound decode? Upstream of split
docs/research_question_bank.md:111:  P2-010 splits into P2-010a suite substrate and P2-010b smoke ladder;
docs/research_question_bank.md:135:Split a suite into balanced blocks when measured wall time exceeds roughly
docs/research_question_bank.md:291:"latest split" (C-015). Field sketch:
docs/research_question_bank.md:308:  source_split
docs/research_question_bank.md:401:- "latest split" support.
docs/research_question_bank.md:491:| Does split inference reduce energy? | L2 boundary-labeled; stronger with wall calibration | "For `<device pair/link/model/shape>`, split total energy `<prefill + serialize + transfer + deserialize + decode>` was `<less/greater>` than the better monolithic reference by `<delta>`, with boundaries named and calibration status stated." | Phase 3 split; Q1/F4/F5. | Cross-boundary sums are descriptive unless calibrated. |
docs/research_question_bank.md:492:| How sensitive is split energy to link speed? | L2 | "For `<payload/model/pair>`, changing `<1GbE/2.5GbE/10GbE>` changed transfer energy/time by `<delta>` and moved/did not move the crossover within the measured range." | P1-004 links + transfer bench. | Link throughput must be measured, not assumed. |
docs/research_question_bank.md:493:| What is the split energy-latency Pareto frontier? | L2 | "Within `<comparison set>`, `<configuration>` is Pareto-frontier because no measured alternative had both lower energy/token and lower `<latency metric>`." | Phase 3 + F6. | Latency metric choice must be fixed per figure. |
docs/research_question_bank.md:494:| Does measurement boundary change conclusions? | L2; L4 only with replication | "For `<condition pair>`, the conclusion under platform rails `<matched/flipped>` under `wall_meter AC` by `<delta>`." | P1-003 wall meter; Q6/F11. | Wall-meter synchronization/export quality. |
docs/research_question_bank.md:495:| Do KV-size predictions match measured transfer economics? | L2 | "For `<runtime/model/link>`, analytic KV size predicted serialized payload within `<error>` and transfer energy/GiB within `<interval>`." | P1-004 + P1-006; C5-2.3. | Runtime cache format must be portable or explicitly scoped. |
docs/research_question_bank.md:497:| Local-vs-datacenter full-system crossover? | Scenario result, not measured-equivalent cloud claim | "Under documented external datacenter-energy assumptions and local `wall_meter AC` measurement, local request energy was `<less/greater>` than the modeled remote alternative for `<workload>`." | Wall meter + network leg; C5-2.9. | Cloud-side energy remains assumption-based, not measured by JouleWise. |
docs/research_question_bank.md:568:**The split study is a first-of-kind edge measurement.** Prefill/decode
docs/research_question_bank.md:569:disaggregation is argued from datacenter throughput; nobody has measured
docs/research_question_bank.md:571:per-stage decomposition (prefill/serialize/transfer/deserialize/decode).
docs/research_question_bank.md:680:  earliest phase: **NV**. On the 3080 Ti, same model artifact where format
docs/research_question_bank.md:761:**Sources to pin (hash-manifested frozen subsets, never "latest split"):**
docs/research_question_bank.md:825:the 3080 Ti borrow window (Phase 3 interconnect sweep only), P1-003 wall
docs/research_question_bank.md:826:meter decision (R-007), P1-004 network topology (1GbE / 2.5GbE / optional
docs/research_question_bank.md:830:  to llama.cpp-CUDA/vLLM on the 3050: is the time-vs-watts split of
docs/research_question_bank.md:836:- **C5-2.2 Batch size and the prefill/decode energy split.** Does
docs/research_question_bank.md:837:  static batching reshape gross energy/request and the phase split under
docs/research_question_bank.md:849:- **C5-2.3 Predicted-vs-measured KV economics.** Does the analytic
docs/research_question_bank.md:850:  kv-size model predict serialized cache size, transfer energy, and
docs/research_question_bank.md:851:  deserialize energy? Measure: transfer joules/GiB both ends over
docs/research_question_bank.md:853:  vs actual deltas calibrate the model. Gates: P1-004 links + any second
docs/research_question_bank.md:854:  node (P1-006). Methodology: both-end sampling, clock-offset bounds
docs/research_question_bank.md:856:  disaggregated-inference researchers, KV-cache system builders.
docs/research_question_bank.md:858:- **C5-2.4 KV-cache quantization end-to-end.** Does q8_0 cache save
docs/research_question_bank.md:860:  P1-006 + P1-004 (llama.cpp cache portability spike verdict). Who
docs/research_question_bank.md:924:  M3 Max / 3050 / Orin (+3080 Ti in window): do rankings survive
docs/research_question_bank.md:932:  build/model/quant) across M3 Max Metal and 3080 Ti CUDA, does recorded
docs/research_question_bank.md:941:- **C5-2.8 Placement-policy optimality from Q4 coefficients.** Can
docs/research_question_bank.md:942:  fitted fixed+marginal coefficients + measured transfer costs choose
docs/research_question_bank.md:944:  measured splits? Gates: full Phase 3 set (P1-006, P1-004, borrow
docs/research_question_bank.md:946:  Who cares: disaggregated-serving and placement-policy researchers.
docs/research_question_bank.md:950:  shipping it out — full-system watts, transfer included, datacenter
docs/research_question_bank.md:952:  equivalent? Gates: P1-003 wall meter (+P1-004 for transfer leg).
docs/research_question_bank.md:953:  Methodology: the wall meter is what makes the local side full-system
docs/research_question_bank.md:961:  rail-vs-wall differently. Gate: P1-003. Methodology: pairs with
docs/research_question_bank.md:962:  C5-1.2/C5-2.3 threat notes; turns their caveat into a measured
docs/research_question_bank.md:970:  of C5-2.4 (no transfer leg, runnable on the D-073 fleet now)**. Forbidden
docs/research_question_bank.md:971:  upgrade: **No byte-saving-equals-energy-saving claim (inherits C5-2.4's
docs/research_question_bank.md:974:  C5-2.4, C5-1.12, and C-023-QUALITY-EQUIV-QUANT. Evidence: [2026-07-17
docs/research_question_bank.md:1025:  complementary to the AC wall meter.
docs/research_question_bank.md:1092:Deferred/killed applications: carbon LABELS (needs wall meter + grid
...
exec
/bin/zsh -lc "sed -n '100,214p' docs/strategy/2026-08-06-impressiveness-roadmap.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
  ]
}
```
...
codex
The evidence supports a narrower, stronger paper than “live distributed inference saves energy.” The defensible extension is a two-boundary measurement-method study: synthetic transfer plus offline prefill/KV-transfer/decode replay, with live split and any energy-winner claim gated on portability and wall-boundary validation. I’m checking the existing split/KV replay machinery and measured timing/payload diagnostics now.
exec
/bin/zsh -lc "rg --files | rg -i '(split|disagg|transfer|kv|wall|wt310|clock|multi.*node|3080|nvidia)' | head -n 300" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
joulewise/adapters/nvidia_smi.py
joulewise/kv_size.py
joulewise/clock.py
scripts/quiet_window_clock.sh
configs/examples/nvidia_vllm_ssh.json
...
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b04-b1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b01-b2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b02-a2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b03-a2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b05-b1.json
configs/campaigns/splitwise_decode_v1/README.md
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b02-b2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b03-b2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b05-a1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b01-a2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b04-a1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b04-a2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b01-a1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b05-b2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b03-a1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b02-a1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b04-b2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b01-b1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/order_manifest.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b05-a2.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b03-b1.json
configs/campaigns/splitwise_decode_v1/01_decode_contrast_blocks_01_05/swdec-contrast-b02-b1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b10-b1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b09-b1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b06-a2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b08-b1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b07-a2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b10-a1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/order_manifest.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b06-b2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b09-a1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b07-b2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b08-a1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b07-b1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b08-a2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b06-b1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b09-a2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b10-a2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b08-b2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b07-a1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b09-b2.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b06-a1.json
configs/campaigns/splitwise_decode_v1/02_decode_contrast_blocks_06_10/swdec-contrast-b10-b2.json
configs/campaigns/splitwise_decode_v1/calibration_plan.sha256
tests/test_audit_clock.py
tests/test_clock.py
docs/phase_3/kv_feasibility.md
docs/stream_logs/2026-07-16-split-ap.md
docs/stream_logs/2026-07-07-2k-nvidia.md
docs/stream_logs/2026-07-07-kv-spike-301.md
docs/stream_logs/2026-07-07-kv-spike-301/codex-impl-round1.md
docs/stream_logs/2026-07-07-kv-spike-301/lens-isolation.md
docs/stream_logs/2026-07-07-kv-spike-301/spike_report_1024.json
docs/stream_logs/2026-07-07-kv-spike-301/lens-evidence.md
docs/stream_logs/2026-07-07-kv-spike-301/codex-impl-round2.md
docs/stream_logs/2026-07-07-kv-spike-301/spike_report_2048.json
tests/test_kv_size.py
tests/test_nvidia_smi.py
docs/specs/c027/split-ap_ap-edit_amendments.md
...
exec
/bin/zsh -lc "wc -l docs/phase_3/kv_feasibility.md docs/campaign_packs/split_suite_q1_q2_q3.md docs/campaign_packs/c5_2_3_kv_economics.md docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md docs/phase_2/splitwise_replication_roadmap.md docs/stream_logs/2026-07-07-kv-spike-301/spike_report_1024.json docs/stream_logs/2026-07-07-kv-spike-301/spike_report_2048.json && sed -n '1,260p' docs/phase_3/kv_feasibility.md && sed -n '1,260p' docs/campaign_packs/split_suite_q1_q2_q3.md && sed -n '1,220p' docs/campaign_packs/c5_2_3_kv_economics.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
     103 docs/phase_3/kv_feasibility.md
     449 docs/campaign_packs/split_suite_q1_q2_q3.md
     264 docs/campaign_packs/c5_2_3_kv_economics.md
     206 docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md
     131 docs/phase_2/splitwise_replication_roadmap.md
      42 docs/stream_logs/2026-07-07-kv-spike-301/spike_report_1024.json
      42 docs/stream_logs/2026-07-07-kv-spike-301/spike_report_2048.json
    1237 total
...
exec
/bin/zsh -lc 'rg -n -i "RTX 3080|3080 Ti|power|transfer|energy|joule|clock|link|1GbE|2.5GbE|offline|split|wall" docs/phase_3 docs/campaign_packs/split_suite_q1_q2_q3.md docs/campaign_packs/c5_2_3_kv_economics.md docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md docs/decision_log.md | head -n 320' in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:1:# Q6 / C5-2.10 Pack: Rail-Vs-Wall Boundary Sensitivity
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:11:| family_id | FAM-Q6-RAIL-WALL-BOUNDARY |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:13:| selection_scope | Frozen paired boundary campaign for `<<TARGET_DEVICE>>`, platform telemetry backend `<<RAIL_BACKEND>>`, external boundary `wall_meter` or `USB-C PD/DC`, and workload-profile set resolved at registry freeze to one of `{mid_mid}`, `{mid_mid,long_prompt}`, `{mid_mid,long_decode}`, or `{mid_mid,long_prompt,long_decode}`, with one model artifact, one runtime, and matched platform-vs-external windows. Excluded long profiles require named `DROP-FEASIBILITY-P1-004-P1-006-BOUNDARY-PROFILE` evidence before any campaign bundle exists. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:14:| multiplicity_rule | Holm within FAM-Q6-RAIL-WALL-BOUNDARY across predeclared workload-profile boundary deltas and conclusion-flip tests. Any post-hoc workload, boundary, or backend subset is exploratory. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:15:| Metric + exact window class | Primary: workload-induced delta energy by boundary on gross request windows and idle-subtracted request windows: `delta_external_j`, `delta_platform_j`, `external_minus_platform_j`, and sign/direction of any conclusion flip. Calibration descriptors may include session-window idle and sustained blocks. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:18:| Inclusion/exclusion + quality-flag waiver rules | Strict-valid JouleWise bundles plus external meter artifact required. Exclude blocks without synchronization evidence, meter calibration/status, meter cadence, platform rail manifest, shared marker plan/manual sync note, or matched window definitions. Waivers must be named in the frozen registry and cannot turn missing external evidence into a calibrated claim. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:20:| Floor gate | pending-P2-015: consume `DF-RQ-GROSS-MID` (`gross_energy_j`, gross request), `DF-RQ-IDLE-MID` (`energy_request_j`, `idle_subtracted_energy_j`, idle-sub request), optional `DF-RQ-GROSS-LONG-PROMPT` / `DF-RQ-IDLE-LONG-PROMPT` for matching-or-harder long-prompt claims, optional `DF-RQ-GROSS-LONG-DECODE` / `DF-RQ-IDLE-LONG-DECODE` for matching-or-harder long-decode claims, and `DF-CMP-ABBA-RQ` (`gross_energy_j`, `energy_request_j`, request windows). Canonical `mid_mid` is 1024/256. Any 8192/256 long-prompt request cell and any 2048/2048 request cell are capped until P2-015 adds matching-or-harder cells or the frozen AP names an accepted AP-specific bound; ambiguous coverage must consume every plausible harder cell and take the maximum floor. Phase-window boundary claims additionally consume `DF-PH-PREFILL`, `DF-PH-DECODE`, and `DF-CMP-ABBA-PH` only if cadence and clock thresholds clear. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:24:| Claim ceiling + exact forbidden upgrade | `L2; L4 only with replication`. Forbidden upgrade: `no wall/rail conclusion flip claim without paired boundary plan`. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:25:| Disqualifiers + not-resolvable conditions | No external meter trace; unmatched platform/external windows; missing rail manifest; missing meter calibration/status; clock/sync bound too large; floor missing for the metric/window class; bridge residual above threshold; or single-unit evidence used for vendor/hardware-class wording. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:26:| Linked manifests/bundle hashes | pending post-execution; filled at registry freeze and final reduction. |
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:30:The JouleWise workload half is current v0.1. External-meter capture/import is
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:31:PLANNED under P1-003 wall-meter evidence and P2-015 calibration runbooks. The
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:57:    "notes": "Q6 paired rail-vs-wall boundary campaign; external meter trace is paired outside current v0.1 config."
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:70:    "power_hz": 10.0,
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:75:    "project": "capstone-joulewise",
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:77:    "tags": ["q6", "c5-2.10", "boundary", "rail-vs-wall"]
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:83:are identical JouleWise workload labels under simultaneous external metering.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:96:`events.jsonl`, `power_trace.csv`, raw telemetry under `raw/`, logs, outputs,
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:112:synchronization method. The marker/clock-offset expectations follow D-003:
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:114:window shorter than the recorded clock/sync bound is not used for attribution.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:123:F-Q6-BOUNDARY-SCATTER: external vs platform workload-induced energy.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:125:- x-axis: platform rail/model energy delta (J), boundary label
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:127:- y-axis: external meter energy delta (J), boundary label `wall_meter full
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:135:- Caption adds: `Boundary labels differ across cells, so absolute energy values are descriptive rather than a calibrated cross-target ranking.` when residual threshold has not cleared.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:140:- y-axis: paired contrast energy (J), with separate rail and wall/PD points.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:146:- P1-003 wall meter or PD/DC analyzer decision, including export/logging
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:151:- Synchronization method that satisfies D-003 and P2-015 clock-bound gates.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:158:python3 -m joulewise validate-config configs/campaign_packs/<<Q6_CONFIG>>.json
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:159:python3 -m joulewise run configs/campaign_packs/<<Q6_CONFIG>>.json --runs-dir runs
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:161:python3 -m joulewise validate-bundle --strict runs/<<BASE_RUN_ID>>__r1
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:162:python3 -m joulewise reduce runs/<<BASE_RUN_ID>>__r1
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:170:# PLANNED, owner: P1-003 wall-meter evidence plus P2-015 calibration runbook.
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:171:python3 -m joulewise import-external-meter --bundle runs/<<BASE_RUN_ID>>__r1 --trace <<METER_TRACE_CSV>> --metadata <<METER_METADATA_JSON>>
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:174:python3 -m joulewise boundary-calibrate runs/<<BASE_RUN_ID_A>>__r1 runs/<<BASE_RUN_ID_B>>__r1 --output runs/analysis/<<Q6_RESULTS>>.json
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:190:   with schema `joulewise.order_manifest.v1`, including paired ABBA-like
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:197:4. Start external meter logging, run JouleWise workload bundles, and preserve
docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md:199:5. Strict-validate and reduce JouleWise member bundles
docs/campaign_packs/split_suite_q1_q2_q3.md:1:# Split Inference Suite Pack: Q1, Q2, Q3
docs/campaign_packs/split_suite_q1_q2_q3.md:4:entries. Freeze them only after device/link placeholders are filled and before
docs/campaign_packs/split_suite_q1_q2_q3.md:5:any split hardware execution.
docs/campaign_packs/split_suite_q1_q2_q3.md:7:SPLIT-AP policy freeze: COMPLETE. The primary estimand, service state,
docs/campaign_packs/split_suite_q1_q2_q3.md:9:must not change in response to split data. The campaign-specific rows remain
docs/campaign_packs/split_suite_q1_q2_q3.md:11:still open. Named open gates include `OPEN-GATE-SPLITAP-PACK-LINT`, required by
docs/campaign_packs/split_suite_q1_q2_q3.md:12:`docs/specs/c027/ADJUDICATION.md` (SPLIT-AP / Pack-lint timing) before registry
docs/campaign_packs/split_suite_q1_q2_q3.md:13:freeze or split execution; this documentation freeze does not close it; and
docs/campaign_packs/split_suite_q1_q2_q3.md:14:`OPEN-SPLIT-PRED-FIXED-COMPOSITION`, required by D-067 and this pack's Q1 D-048
docs/campaign_packs/split_suite_q1_q2_q3.md:21:Packaging decision: Q1/Q2/Q3 are one split-suite pack because all three consume
docs/campaign_packs/split_suite_q1_q2_q3.md:22:the same device-pair/link matrix, composite split bundles, split-stage windows,
docs/campaign_packs/split_suite_q1_q2_q3.md:23:transfer-boundary labels, and monolithic references. Keeping one pack prevents
docs/campaign_packs/split_suite_q1_q2_q3.md:31:| Plan ID / RQ consumer | DRAFT-AP-SPLIT-Q1 / Q1 split reduces energy. DRAFT until registry freeze. |
docs/campaign_packs/split_suite_q1_q2_q3.md:32:| family_id | FAM-SPLIT-Q1-ENERGY-CROSSOVER |
docs/campaign_packs/split_suite_q1_q2_q3.md:34:| selection_scope | Frozen split matrix for `<<DEVICE_PAIR>>`, `<<MODEL_SET>>` resolved at registry freeze to either `{Qwen2.5-1.5B}` or `{Qwen2.5-1.5B, Qwen2.5-7B}`, prompt lengths `{512,2048,8192}`, decode length `256`, links `<<LINK_MBPS_SET>>`, split mode `offline_replay` unless explicitly frozen as analytical composition, and both required monolithic references for the same model/runtime/artifact. Dropping the 7B cells requires named `DROP-FEASIBILITY-P1-004-P1-006-MODEL-7B` evidence before any campaign bundle exists. |
docs/campaign_packs/split_suite_q1_q2_q3.md:35:| multiplicity_rule | Holm within FAM-SPLIT-Q1-ENERGY-CROSSOVER across the predeclared split-vs-monolithic-reference contrasts (prefill-node and decode-node references) for each frozen model x prompt x link x pairing cell. Any unplanned model, prompt, link, runtime, or boundary subset is exploratory; the Holm denominator counts both reference contrasts per cell in the enumerated contrast_id set. |
docs/campaign_packs/split_suite_q1_q2_q3.md:36:| Metric + exact window class | Primary (single frozen estimand): `split_total_energy_j = prefill + serialize + transfer + deserialize + decode` as composite GROSS request energy, under the frozen service-state assumption of two already-powered warm nodes (decode-node model loaded before the measured window); the headline crossover verdict uses this basis only. Named sensitivity analyses, never headline-eligible: `SENS-SPLIT-Q1-IDLESUB` (composite idle-subtracted request energy, with each end's own idle floor subtracted over its own stage windows, computed only where both ends have usable idle baselines; consistent with D-067, reader-facing reporting is limited to clearly labeled per-end, within-device marginal diagnostics and cannot support a split-vs-monolithic contrast, configuration rank, Pareto frontier, or crossover verdict) and `SENS-SPLIT-Q1-PROVISION` (gross composite plus the decode-oriented second node's measured idle power charged for the full request duration; descriptive, L1 ceiling). Stage descriptors use gross phase windows: `phase_energy_j.prefill`, `phase_energy_j.serialize`, `phase_energy_j.transfer`, `phase_energy_j.deserialize`, and `phase_energy_j.decode`. |
docs/campaign_packs/split_suite_q1_q2_q3.md:37:| Unit of analysis + dependence structure | Composite bundle repetition; stage energies are nested within a composite split bundle and are not independent replicates. Monolithic references are bundle-level repetitions matched by model/runtime/artifact/version and blocked by session/link where possible. |
docs/campaign_packs/split_suite_q1_q2_q3.md:38:| Estimator/formula | For each frozen cell, estimate two predeclared contrasts: `delta_prefill_ref_j = split_total_energy_j - monolithic_total_j(prefill_node)` and `delta_decode_ref_j = split_total_energy_j - monolithic_total_j(decode_node)`, each with paired/block contrast when the monolithic reruns are in the same campaign block, otherwise the predeclared unpaired contrast with session covariate. Both contrasts enter the enumerated FAM-SPLIT-Q1-ENERGY-CROSSOVER contrast_id set and are Holm-adjusted within the family. "Split wins" in a cell is an intersection–union verdict: it holds only if BOTH Holm-adjusted 95% contrast intervals lie entirely below zero AND both contrasts clear the active floor gate; if either contrast fails, the cell verdict is "no crossover" or `not resolvable` per the three-way wording rule (D-053). No comparator may be selected after observing the data; the observed-minimum reference is forbidden. D-048 prediction validation also estimates prediction error `measured_split_total_j - predicted_split_total_j` on the GROSS basis, where prediction is the prefill-node AP-1 gross-fit terms plus GROSS measured-or-predicted serialize energy plus measured link-transfer energy plus GROSS measured-or-predicted deserialize energy plus the decode-node AP-1 gross-fit terms before any split hardware run; each node's fixed/overhead contribution is that node's AP-1 GROSS-FITTED fixed term, never a measured idle-floor substitute or an additional idle-floor charge. Crossover exists only where the intersection–union verdict above holds (both references beaten under joint Holm-adjusted intervals, both clearing the floor gate). |
docs/campaign_packs/split_suite_q1_q2_q3.md:39:| Inclusion/exclusion + quality-flag waiver rules | Strict-valid composite bundles and strict-valid monolithic reference bundles only. Exclude any composite missing payload manifest, clock-offset bound, per-node metadata, stage marker pair, model/artifact hash, or greedy output-equivalence check. D-014 quality waivers must be named in the frozen registry and report text; unwaived suspect flags stay in sensitivity tables but do not support L2 wording. |
docs/campaign_packs/split_suite_q1_q2_q3.md:40:| Order/blocking/covariates | Counterbalanced round-robin order by model x prompt x link x split/monolithic condition where model reload cost permits, following D-014/C-011 conventions. If operational blocks are forced, record executed order in the experiment manifest and include session/block/link-position drift terms. Start/end drift sentinels bracket each hardware session. |
docs/campaign_packs/split_suite_q1_q2_q3.md:41:| Floor gate | pending-P2-015: use `max(floor_abs_j, floor_cmp_j)` for the same backend, metric, and window class. Existing request rows can gate same-node request companions, not the composite split-total metric: `DF-RQ-GROSS-MID` (`gross_energy_j`, gross request), `DF-RQ-IDLE-MID` (`energy_request_j`, `idle_subtracted_energy_j`, idle-sub request), `DF-RQ-GROSS-LONG-PROMPT` (`gross_energy_j`, gross request), `DF-RQ-IDLE-LONG-PROMPT` (`energy_request_j`, `idle_subtracted_energy_j`, idle-sub request), and `DF-CMP-ABBA-RQ` (`gross_energy_j`, `energy_request_j`, request windows). The 2048/256 request cells consume the ambiguity-rule maximum of `DF-RQ-*-MID` and `DF-RQ-*-LONG-PROMPT`; 8192/256 request cells are capped until P2-015 adds matching-or-harder >=8192 prompt / 256 decode rows or the frozen AP names an accepted AP-specific bound. Any 2048/2048 request cell is likewise capped until P2-015 adds a matching-or-harder cell or the frozen AP names a bound. Stage descriptors consume `DF-PH-PREFILL` (`phase_energy_j.prefill`, phase window), `DF-PH-DECODE` (`phase_energy_j.decode`, phase window), and `DF-CMP-ABBA-PH` (`phase_energy_j.prefill`, `phase_energy_j.decode`, phase windows). No exact P2-015 row currently exists for composite `split_total_energy_j`, `serialize`, `transfer`, or `deserialize`; standalone L2/L3 claims for those terms are capped until P2-015 adds rows, adds a composite row, or this AP freezes an accepted AP-specific bound or combination rule. Per SPLIT-AP, the missing composite/serialize/transfer/deserialize rows are an execution prerequisite, not merely a claim cap. |
docs/campaign_packs/split_suite_q1_q2_q3.md:42:| MDE/n sizing + predeclared top-up rule | Headline pairing cells: n=10 when Window-A evidence expects a near-floor contrast (D-048 prediction error near floor, or contrast MDE within 2x of the floor gate), n>=5 otherwise; n>=3 minimum for non-headline cells. Sizing authority: D-062 + `configs/analysis_registry/<<SPLIT_Q1_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
docs/campaign_packs/split_suite_q1_q2_q3.md:43:| Denominator provenance requirement | Runtime-observed output tokens, stop reasons, output policy, model artifact hashes, serialized payload bytes, payload SHA-256, effective link throughput, and per-node idle baselines. Config-token fallback cannot support per-token or latency-normalized L2 claims. |
docs/campaign_packs/split_suite_q1_q2_q3.md:45:| Claim ceiling + exact forbidden upgrade | `L2 boundary-labeled; stronger only with calibration`. Forbidden upgrade: `no uncalibrated cross-boundary total-energy winner`. |
docs/campaign_packs/split_suite_q1_q2_q3.md:46:| Disqualifiers + not-resolvable conditions | Below-floor contrast; missing P2-015 floor row for the claim window; transfer-stage boundary mismatch without D-049 label; cross-boundary quantitative winner without D-018 calibration bridge; clock-offset bound longer than the attributed interval; non-identical greedy output without scoped explanation; incomplete payload manifest; short windows under 3 samples; or monolithic reference version drift. |
docs/campaign_packs/split_suite_q1_q2_q3.md:47:| Linked manifests/bundle hashes | pending post-execution; filled at registry freeze and final reduction. |
docs/campaign_packs/split_suite_q1_q2_q3.md:51:Before any split hardware run, generate predicted split-energy curves per
docs/campaign_packs/split_suite_q1_q2_q3.md:52:pairing/link and record them in the seeded AP row/frozen registry. The model is
docs/campaign_packs/split_suite_q1_q2_q3.md:56:predicted_split_total_j(prompt, link, pair)
docs/campaign_packs/split_suite_q1_q2_q3.md:59:  + measured_link_transfer_j(payload_bytes, link, pair)
docs/campaign_packs/split_suite_q1_q2_q3.md:69:path. AP-1's fitted fixed coefficient is energy (joules) per the AP-1 GROSS fit,
docs/campaign_packs/split_suite_q1_q2_q3.md:70:not power. `OPEN-SPLIT-PRED-FIXED-COMPOSITION` is a named open item: before
docs/campaign_packs/split_suite_q1_q2_q3.md:71:campaign-row freeze, the registry must freeze how the two fitted fixed energy
docs/campaign_packs/split_suite_q1_q2_q3.md:74:units, from each AP-1 fixed energy coefficient to the composed predictor term.
docs/campaign_packs/split_suite_q1_q2_q3.md:80:observing split data. Split execution remains gated while any part of this
docs/campaign_packs/split_suite_q1_q2_q3.md:83:The feasible set must include at least one pairing/link cell where the model
docs/campaign_packs/split_suite_q1_q2_q3.md:99:| Plan ID / RQ consumer | DRAFT-AP-SPLIT-Q2 / Q2 link bandwidth sensitivity. DRAFT until registry freeze. |
docs/campaign_packs/split_suite_q1_q2_q3.md:100:| family_id | FAM-SPLIT-Q2-LINK-SENSITIVITY |
docs/campaign_packs/split_suite_q1_q2_q3.md:102:| selection_scope | Frozen `<<DEVICE_PAIR>>` and model/prompt/decode set from the split suite, limited to links `<<LINK_MBPS_SET>>` with measured effective throughput and transfer energy. |
docs/campaign_packs/split_suite_q1_q2_q3.md:103:| multiplicity_rule | Holm within FAM-SPLIT-Q2-LINK-SENSITIVITY across predeclared link-speed contrasts within each model x prompt x device-pair cell. Exploratory for unplanned links or nominal-link-only comparisons. |
docs/campaign_packs/split_suite_q1_q2_q3.md:104:| Metric + exact window class | Primary: transfer time seconds, effective throughput MiB/s, gross transfer-stage energy joules, and composite GROSS `split_total_energy_j` on request windows. Companion latency: end-to-end split latency seconds and stage latencies seconds. |
docs/campaign_packs/split_suite_q1_q2_q3.md:105:| Unit of analysis + dependence structure | Composite transfer/split bundle repetition, blocked by payload/link/session. Sender and receiver transfer windows inside one composite bundle are dependent components, not separate replicates. |
docs/campaign_packs/split_suite_q1_q2_q3.md:106:| Estimator/formula | Within-cell link contrast: `delta_link = metric(link_b) - metric(link_a)` using paired/block contrast when the same payload order is counterbalanced across links. Crossover movement is reported as change in the prompt-length crossing point only when both links have measured transfer energy and the Q1 contrast clears its floor. |
docs/campaign_packs/split_suite_q1_q2_q3.md:107:| Inclusion/exclusion + quality-flag waiver rules | Strict-valid composite bundles only; payload byte count and SHA-256 required; link speed must be measured, not assumed. Exclude cells with missing receiver/sender marker bounds, payload mismatch, or transfer-boundary label mismatch for a like-boundary comparison. |
docs/campaign_packs/split_suite_q1_q2_q3.md:108:| Order/blocking/covariates | Counterbalance link order inside each payload/model block: e.g., `1GbE,2.5GbE,2.5GbE,1GbE` across ABBA blocks where hardware switching permits. Record forced order and include session/link-position covariate. |
docs/campaign_packs/split_suite_q1_q2_q3.md:109:| Floor gate | pending-P2-015: same-node request companions consume `DF-RQ-GROSS-MID`, `DF-RQ-IDLE-MID`, `DF-RQ-GROSS-LONG-PROMPT`, `DF-RQ-IDLE-LONG-PROMPT`, and `DF-CMP-ABBA-RQ` for `gross_energy_j` / `energy_request_j` request windows. The 2048/256 request cells consume the ambiguity-rule maximum of the MID and LONG-PROMPT rows; 8192/256 request cells are capped until P2-015 adds matching-or-harder >=8192 prompt / 256 decode rows or the frozen AP names an accepted AP-specific bound. Any 2048/2048 request cell is likewise capped until P2-015 adds a matching-or-harder cell or the frozen AP names a bound. Request-level split-total link sensitivity has no exact composite P2-015 row; it is capped until P2-015 adds a composite row or the frozen AP names an accepted combination rule. Transfer-stage energy has no exact P2-015 transfer-window floor row yet; standalone transfer-energy L2 wording is capped until that row or AP-specific bound exists. Per SPLIT-AP, the missing composite/serialize/transfer/deserialize rows are an execution prerequisite, not merely a claim cap. |
docs/campaign_packs/split_suite_q1_q2_q3.md:110:| MDE/n sizing + predeclared top-up rule | Headline link contrast: n=10 when Window-A evidence marks it near-floor, otherwise n>=5; n>=3 per payload x link cell. Sizing authority: D-062 + `configs/analysis_registry/<<SPLIT_Q2_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
docs/campaign_packs/split_suite_q1_q2_q3.md:111:| Denominator provenance requirement | Payload bytes from `transfer/payload_manifest.json`, payload SHA-256, measured transfer duration, runtime-observed output tokens for total split companions, and recorded link evidence from P1-004. |
docs/campaign_packs/split_suite_q1_q2_q3.md:113:| Claim ceiling + exact forbidden upgrade | `L2`. Forbidden upgrade: `no nominal-link crossover without measured links`. |
docs/campaign_packs/split_suite_q1_q2_q3.md:114:| Disqualifiers + not-resolvable conditions | Nominal link speed without measured throughput; missing payload manifest; transfer window shorter than clock-offset bound; below-floor link effect; transfer-boundary label mismatch; or unplanned link searched after seeing results. |
docs/campaign_packs/split_suite_q1_q2_q3.md:115:| Linked manifests/bundle hashes | pending post-execution; filled at registry freeze and final reduction. |
docs/campaign_packs/split_suite_q1_q2_q3.md:121:| Plan ID / RQ consumer | DRAFT-AP-SPLIT-Q3 / Q3 split energy-latency Pareto. DRAFT until registry freeze. |
docs/campaign_packs/split_suite_q1_q2_q3.md:122:| family_id | FAM-SPLIT-Q3-PARETO |
docs/campaign_packs/split_suite_q1_q2_q3.md:124:| selection_scope | Frozen comparison set from Q1/Q2: monolithic references and split cells for `<<DEVICE_PAIR>>`, `<<MODEL_SET>>`, prompt lengths `{512,2048,8192}`, decode length `256`, links `<<LINK_MBPS_SET>>`, and a single frozen latency metric per figure. |
docs/campaign_packs/split_suite_q1_q2_q3.md:125:| multiplicity_rule | Holm within FAM-SPLIT-Q3-PARETO for predeclared pairwise dominance checks in the frozen comparison set; any expanded all-pairs sweep uses Benjamini-Hochberg at q=0.10 or is exploratory, as frozen in the registry. |
docs/campaign_packs/split_suite_q1_q2_q3.md:126:| Metric + exact window class | Energy axis: composite GROSS request energy (the only Pareto energy axis, matching the SPLIT-AP frozen Q1 estimand). Idle-subtracted energy does not define an energy axis: `SENS-SPLIT-Q1-IDLESUB` may appear only in a separate, clearly labeled per-end within-device marginal diagnostic and never in a Pareto figure, cross-configuration dominance contrast, or rank (D-067). Latency axis: one frozen metric per figure, default end-to-end request latency seconds; companion TTFT seconds and decode latency seconds are descriptive unless frozen as separate figures. |
docs/campaign_packs/split_suite_q1_q2_q3.md:127:| Unit of analysis + dependence structure | Bundle/composite-bundle repetition; Pareto membership is computed from condition-level estimates with raw points shown. Stage windows inside a split bundle are not independent. |
docs/campaign_packs/split_suite_q1_q2_q3.md:128:| Estimator/formula | A condition is Pareto-frontier only if no other frozen condition has both lower energy and lower frozen latency metric after floor and CI checks. Directional dominance uses contrast-level CI, not visual separation of marginal intervals. |
docs/campaign_packs/split_suite_q1_q2_q3.md:129:| Inclusion/exclusion + quality-flag waiver rules | Strict-valid bundles only; every cell must carry boundary label, link label, output policy, and runtime-observed denominator evidence. Exclude cells with non-equivalent output policy or missing latency metric. |
docs/campaign_packs/split_suite_q1_q2_q3.md:131:| Floor gate | pending-P2-015: same-node request-energy companions consume `DF-RQ-GROSS-MID`, `DF-RQ-IDLE-MID`, `DF-RQ-GROSS-LONG-PROMPT`, `DF-RQ-IDLE-LONG-PROMPT`, and `DF-CMP-ABBA-RQ` for request windows. The 2048/256 request cells consume the ambiguity-rule maximum of the MID and LONG-PROMPT rows; 8192/256 request cells are capped until P2-015 adds matching-or-harder >=8192 prompt / 256 decode rows or the frozen AP names an accepted AP-specific bound. Any 2048/2048 request cell is likewise capped until P2-015 adds a matching-or-harder cell or the frozen AP names a bound. Composite split-total Pareto energy has no exact P2-015 row; it is capped until P2-015 adds a composite row or the frozen AP names an accepted combination rule. Latency has no P2-015 energy floor; latency uncertainty follows D-014 contrast CI and run-bundle timing quality fields. Stage-energy captions consume `DF-PH-PREFILL`, `DF-PH-DECODE`, and `DF-CMP-ABBA-PH` only for prefill/decode descriptors. |
docs/campaign_packs/split_suite_q1_q2_q3.md:132:| MDE/n sizing + predeclared top-up rule | n follows the Q1/Q2 source cells. Sizing authority: D-062 + `configs/analysis_registry/<<SPLIT_Q3_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
docs/campaign_packs/split_suite_q1_q2_q3.md:133:| Denominator provenance requirement | Runtime-observed output tokens, stop reason, output policy, request latency, TTFT/decode latency when used, and payload/link evidence for split cells. |
docs/campaign_packs/split_suite_q1_q2_q3.md:136:| Disqualifiers + not-resolvable conditions | Frozen comparison set changed post hoc; latency metric changed per figure; energy contrast below floor; output-policy mismatch; cross-boundary quantitative ranking without calibration; or missing raw points/uncertainty. |
docs/campaign_packs/split_suite_q1_q2_q3.md:137:| Linked manifests/bundle hashes | pending post-execution; filled at registry freeze and final reduction. |
docs/campaign_packs/split_suite_q1_q2_q3.md:142:monolithic references; schema v0.2 split/transfer configs are PLANNED under
docs/campaign_packs/split_suite_q1_q2_q3.md:144:hardware/device-pair slots; `<<LINK_*>>` placeholders are the only link slots.
docs/campaign_packs/split_suite_q1_q2_q3.md:151:  "run_id": "split-ref-<<DEVICE_PAIR.PREFILL_TARGET_ID>>-qwen25-15b-p2048-d256",
docs/campaign_packs/split_suite_q1_q2_q3.md:171:    "notes": "Split-suite monolithic reference for <<DEVICE_PAIR>>."
docs/campaign_packs/split_suite_q1_q2_q3.md:174:    "name": "split_ref_p2048_d256",
docs/campaign_packs/split_suite_q1_q2_q3.md:184:    "power_hz": 10.0,
docs/campaign_packs/split_suite_q1_q2_q3.md:189:    "project": "capstone-joulewise",
docs/campaign_packs/split_suite_q1_q2_q3.md:191:    "tags": ["phase3", "split-suite", "monolithic-reference", "q1", "q2", "q3"]
docs/campaign_packs/split_suite_q1_q2_q3.md:196:### PLANNED Split Offline Replay Template
docs/campaign_packs/split_suite_q1_q2_q3.md:203:  "run_kind": "split_offline",
docs/campaign_packs/split_suite_q1_q2_q3.md:204:  "run_id": "split-offline-<<DEVICE_PAIR>>-<<LINK_MBPS>>mbps-qwen25-15b-p2048-d256",
docs/campaign_packs/split_suite_q1_q2_q3.md:217:  "split_plan": {
docs/campaign_packs/split_suite_q1_q2_q3.md:218:    "mode": "offline_replay",
docs/campaign_packs/split_suite_q1_q2_q3.md:224:    "transfer": {
docs/campaign_packs/split_suite_q1_q2_q3.md:226:      "link_label": "<<LINK_LABEL>>",
docs/campaign_packs/split_suite_q1_q2_q3.md:227:      "link_speed_mbps": "<<LINK_MBPS>>",
docs/campaign_packs/split_suite_q1_q2_q3.md:228:      "staging_dir": "/tmp/joulewise-split-staging",
docs/campaign_packs/split_suite_q1_q2_q3.md:231:    "stage_windows": ["prefill", "serialize", "transfer", "deserialize", "decode"],
docs/campaign_packs/split_suite_q1_q2_q3.md:256:    "power_hz": 10.0,
docs/campaign_packs/split_suite_q1_q2_q3.md:261:    "project": "capstone-joulewise",
docs/campaign_packs/split_suite_q1_q2_q3.md:263:    "tags": ["phase3", "split-suite", "offline-replay", "q1", "q2", "q3"]
docs/campaign_packs/split_suite_q1_q2_q3.md:269:link x condition order. Within each block, execute monolithic prefill-node
docs/campaign_packs/split_suite_q1_q2_q3.md:270:reference, monolithic decode-node reference, and split cell in counterbalanced
docs/campaign_packs/split_suite_q1_q2_q3.md:283:Composite split bundles follow `docs/contracts/run_bundle_layout.md`:
docs/campaign_packs/split_suite_q1_q2_q3.md:291:  transfer/payload_manifest.json
docs/campaign_packs/split_suite_q1_q2_q3.md:296:The composite summary must decompose total split energy into `prefill`,
docs/campaign_packs/split_suite_q1_q2_q3.md:297:`serialize`, `transfer`, `deserialize`, and `decode` components. Per
docs/campaign_packs/split_suite_q1_q2_q3.md:299:window on the prefill node, transfer is the byte-movement window, deserialize
docs/campaign_packs/split_suite_q1_q2_q3.md:301:last-token. Cache load is not decode energy.
docs/campaign_packs/split_suite_q1_q2_q3.md:303:D-049 boundary labels are required per transfer cell:
docs/campaign_packs/split_suite_q1_q2_q3.md:305:- `host-inclusive transfer energy`: wall/PD/SoC/module boundary includes the
docs/campaign_packs/split_suite_q1_q2_q3.md:306:  host or NIC path for the transfer leg.
docs/campaign_packs/split_suite_q1_q2_q3.md:307:- `board-only lower-bound transfer energy`: discrete-GPU board telemetry
docs/campaign_packs/split_suite_q1_q2_q3.md:308:  excludes host CPU/NIC/DRAM transfer work; the value is a lower bound.
docs/campaign_packs/split_suite_q1_q2_q3.md:310:Transfer-energy comparisons are like-boundary only unless a D-018 calibration
docs/campaign_packs/split_suite_q1_q2_q3.md:311:bridge exists. Each composite bundle records D-003 clock-offset marker bounds:
docs/campaign_packs/split_suite_q1_q2_q3.md:312:per-process monotonic-vs-wall offsets, NTP state where determinable, remote
docs/campaign_packs/split_suite_q1_q2_q3.md:315:is not eligible for energy attribution claims.
docs/campaign_packs/split_suite_q1_q2_q3.md:319:F-SPLIT-Q1-CURVES: total energy vs prompt length.
docs/campaign_packs/split_suite_q1_q2_q3.md:322:- y-axis: composite GROSS request energy (J) for split total and both
docs/campaign_packs/split_suite_q1_q2_q3.md:324:- Facets: `<<DEVICE_PAIR>>` x `<<LINK_LABEL>>`.
docs/campaign_packs/split_suite_q1_q2_q3.md:325:- Caption template: `Measurements in this figure characterize one physical unit of [target hardware] running [OS/version], [runtime/library], [model artifact], [quantization], [tokenizer], [sampler/output policy], and [measurement boundary]. They support stack-specific claims under the stated boundary and do not establish hardware-class, vendor-class, or unit-general results without independent replication or calibration evidence.` Boundary labels: `[per-cell host-inclusive transfer energy]` or `[per-cell board-only lower-bound transfer energy]`. For cross-boundary cells: `Boundary labels differ across cells, so absolute energy values are descriptive rather than a calibrated cross-target ranking.`
docs/campaign_packs/split_suite_q1_q2_q3.md:327:F-SPLIT-Q2-LINK: transfer energy/time vs link.
docs/campaign_packs/split_suite_q1_q2_q3.md:329:- x-axis: measured effective throughput (MiB/s) and nominal link label.
docs/campaign_packs/split_suite_q1_q2_q3.md:330:- y-axis left: GROSS transfer-stage energy (J); y-axis right: transfer time (s).
docs/campaign_packs/split_suite_q1_q2_q3.md:332:  transfer-boundary label.
docs/campaign_packs/split_suite_q1_q2_q3.md:334:F-SPLIT-Q3-PARETO: energy-latency frontier.
docs/campaign_packs/split_suite_q1_q2_q3.md:337:- y-axis: composite GROSS request energy (J), the only Pareto energy basis.
docs/campaign_packs/split_suite_q1_q2_q3.md:342:F-SPLIT-PREDICTION: predicted vs measured split total.
docs/campaign_packs/split_suite_q1_q2_q3.md:344:- x-axis: predicted composite GROSS split request energy (J).
docs/campaign_packs/split_suite_q1_q2_q3.md:345:- y-axis: measured composite GROSS split request energy (J).
docs/campaign_packs/split_suite_q1_q2_q3.md:351:- P1-004 link evidence: measured topology/link speeds for `<<LINK_MBPS_SET>>`.
...
docs/campaign_packs/split_suite_q1_q2_q3.md:357:- OPEN EXECUTION/REGISTRY-FREEZE GATE `OPEN-GATE-SPLITAP-PACK-LINT`: per
docs/campaign_packs/split_suite_q1_q2_q3.md:358:  `docs/specs/c027/ADJUDICATION.md` (SPLIT-AP / Pack-lint timing), the required
docs/campaign_packs/split_suite_q1_q2_q3.md:359:  pack-lint must be implemented and pass before registry freeze or split
docs/campaign_packs/split_suite_q1_q2_q3.md:363:  `OPEN-SPLIT-PRED-FIXED-COMPOSITION`: per D-067 and this pack's Q1 D-048
docs/campaign_packs/split_suite_q1_q2_q3.md:368:  registry freeze or split execution.
docs/campaign_packs/split_suite_q1_q2_q3.md:369:- EXECUTION GATE (SPLIT-AP): headline Q1/Q2 split cells may not execute until
docs/campaign_packs/split_suite_q1_q2_q3.md:372:  composite `split_total_energy_j` and for the `serialize`, `transfer`, and
docs/campaign_packs/split_suite_q1_q2_q3.md:373:  `deserialize` windows on the frozen backend/boundary. Executing split bundles
docs/campaign_packs/split_suite_q1_q2_q3.md:377:  family before D-048 split prediction curves are frozen.
docs/campaign_packs/split_suite_q1_q2_q3.md:378:- D-049 transfer-boundary classification for every transfer cell.
docs/campaign_packs/split_suite_q1_q2_q3.md:385:python3 -m joulewise kv-size /Users/edr/jw_models/mlx-community/Qwen2.5-1.5B-Instruct-4bit/config.json --prompt-tokens 512,2048,8192
docs/campaign_packs/split_suite_q1_q2_q3.md:387:python3 -m joulewise validate-config configs/campaign_packs/<<MONOLITHIC_CONFIG>>.json
docs/campaign_packs/split_suite_q1_q2_q3.md:389:python3 -m joulewise validate-bundle --strict runs/<<BASE_RUN_ID>>__r1
docs/campaign_packs/split_suite_q1_q2_q3.md:390:python3 -m joulewise reduce runs/<<BASE_RUN_ID>>__r1
docs/campaign_packs/split_suite_q1_q2_q3.md:399:python3 -m joulewise transfer-bench configs/campaign_packs/<<TRANSFER_BENCH_CONFIG>>.json --runs-dir runs
docs/campaign_packs/split_suite_q1_q2_q3.md:402:python3 -m joulewise run configs/campaign_packs/<<SPLIT_OFFLINE_CONFIG>>.json --runs-dir runs
docs/campaign_packs/split_suite_q1_q2_q3.md:405:python3 -m joulewise validate-bundle --strict runs/<<COMPOSITE_SPLIT_BASE_RUN_ID>>__r1
docs/campaign_packs/split_suite_q1_q2_q3.md:406:python3 -m joulewise reduce runs/<<COMPOSITE_SPLIT_BASE_RUN_ID>>__r1
docs/campaign_packs/split_suite_q1_q2_q3.md:421:   `OPEN-SPLIT-PRED-FIXED-COMPOSITION` must be closed under D-067 and this
docs/campaign_packs/split_suite_q1_q2_q3.md:431:   with schema `joulewise.order_manifest.v1`, including rotated
docs/campaign_packs/split_suite_q1_q2_q3.md:432:   model x prompt x link x condition order and start/end
docs/campaign_packs/split_suite_q1_q2_q3.md:437:   split-suite matrices is a PLANNED prerequisite owned by Phase 3 Stage 3.1
docs/campaign_packs/split_suite_q1_q2_q3.md:444:6. Execute transfer bench and split offline runs once planned commands exist.
docs/campaign_packs/c5_2_3_kv_economics.md:3:Status: pre-hardware DRAFT. This pack remains useful even if live split fails:
docs/campaign_packs/c5_2_3_kv_economics.md:4:it validates the analytic KV payload and transfer-economics terms that feed
docs/campaign_packs/c5_2_3_kv_economics.md:5:the split model.
docs/campaign_packs/c5_2_3_kv_economics.md:14:| selection_scope | Frozen runtime/model set `<<MODEL_SET>>`, prompt lengths `{512,2048,8192}`, decode length `256`, links `<<LINK_MBPS_SET>>`, device pair `<<DEVICE_PAIR>>`, runtime cache format, and transfer method. Includes analytic KV-size prediction, serialized payload size, transfer time/energy, deserialize/load time/energy, and measured split or replay evidence where available. |
docs/campaign_packs/c5_2_3_kv_economics.md:15:| multiplicity_rule | Holm within FAM-C5-23-KV-ECONOMICS across predeclared prediction-error contrasts for payload bytes, transfer energy/GiB, transfer time/GiB, and deserialize energy/time for each frozen runtime x model x link family. Broad payload sweeps beyond the frozen set are Benjamini-Hochberg q=0.10 or exploratory as recorded at registry freeze. |
docs/campaign_packs/c5_2_3_kv_economics.md:16:| Metric + exact window class | Payload bytes and prediction percent error; transfer energy J/GiB and transfer time s/GiB on transfer windows; deserialize/cache-load energy J and time s on phase windows; optional composite request total for split/replay validation. |
docs/campaign_packs/c5_2_3_kv_economics.md:17:| Unit of analysis + dependence structure | Payload/replay bundle repetition. Sender/receiver transfer components and deserialize stage are dependent components of the same composite or replay cell. |
docs/campaign_packs/c5_2_3_kv_economics.md:18:| Estimator/formula | Analytic KV bytes per token: `2 * n_layers * n_kv_heads * head_dim * dtype_bytes`, multiplied by prompt tokens and adjusted only by predeclared runtime cache dtype/layout metadata. Prediction error: `measured_payload_bytes - predicted_payload_bytes` and percent error. Transfer economics: `transfer_energy_j / payload_gib`, `transfer_time_s / payload_gib`; deserialize economics: `deserialize_energy_j` and `deserialize_time_s` per payload. |
docs/campaign_packs/c5_2_3_kv_economics.md:19:| Inclusion/exclusion + quality-flag waiver rules | Strict-valid transfer/replay/composite bundles only; include only cells with actual payload size, payload SHA-256, runtime cache format/version, link measurement, and cache-load markers. Exclude cells where cache is not portable unless the row is explicitly scoped to same-machine replay. Waivers must be named before registry freeze. |
docs/campaign_packs/c5_2_3_kv_economics.md:20:| Order/blocking/covariates | Counterbalanced payload/link order by model and prompt length. Use ABBA duplicate-payload blocks for transfer repeatability where possible. Record block/session/link-position covariates and cooldown notes. |
docs/campaign_packs/c5_2_3_kv_economics.md:21:| Floor gate | pending-P2-015: same-node request companions consume `DF-RQ-GROSS-MID`, `DF-RQ-IDLE-MID`, `DF-RQ-GROSS-LONG-PROMPT`, `DF-RQ-IDLE-LONG-PROMPT`, and `DF-CMP-ABBA-RQ` for request windows. The 2048/256 request cells consume the ambiguity-rule maximum of the MID and LONG-PROMPT rows; 8192/256 request cells are capped until P2-015 adds matching-or-harder >=8192 prompt / 256 decode rows or the frozen AP names an accepted AP-specific bound. Any 2048/2048 request cell is likewise capped until P2-015 adds a matching-or-harder cell or the frozen AP names a bound. Optional composite request validation has no exact P2-015 composite row and is capped until P2-015 adds a composite row or the frozen AP names an accepted combination rule. Decode-stage companions consume `DF-PH-DECODE` and `DF-CMP-ABBA-PH`; prefill descriptors consume `DF-PH-PREFILL`. No exact P2-015 rows currently exist for `transfer` or `deserialize`; C5-2.3 L2 claims about those terms require P2-015 to add transfer/deserialize rows or this AP to freeze an accepted AP-specific bound. |
docs/campaign_packs/c5_2_3_kv_economics.md:22:| MDE/n sizing + predeclared top-up rule | Preserve n>=3 per payload/link cell and n>=5 for headline runtime/model/link cells. Sizing authority: D-062 + `configs/analysis_registry/<<C523_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
docs/campaign_packs/c5_2_3_kv_economics.md:23:| Denominator provenance requirement | Model config fields `n_layers`, `n_kv_heads`, `head_dim`, dtype bytes, prompt tokens, runtime cache format/version, serialized payload bytes, payload SHA-256, link throughput, transfer duration, deserialize/load markers, output tokens/stop reason for split validation companions. |
docs/campaign_packs/c5_2_3_kv_economics.md:25:| Claim ceiling + exact forbidden upgrade | `L2`. Forbidden upgrade: `no KV economics claim without measured payload/link/deserialization terms`. |
docs/campaign_packs/c5_2_3_kv_economics.md:26:| Disqualifiers + not-resolvable conditions | Missing measured payload bytes; nominal link speed without measured throughput; no deserialize/cache-load markers; transfer/deserialize floor row missing for a standalone L2 stage claim; clock-offset bound too large; runtime cache format not pinned; or cache portability failure hidden instead of scoped. |
docs/campaign_packs/c5_2_3_kv_economics.md:27:| Linked manifests/bundle hashes | pending post-execution; filled at registry freeze and final reduction. |
docs/campaign_packs/c5_2_3_kv_economics.md:36:python3 -m joulewise kv-size /Users/edr/jw_models/mlx-community/Qwen2.5-1.5B-Instruct-4bit/config.json --prompt-tokens 512,2048,8192
docs/campaign_packs/c5_2_3_kv_economics.md:44:### PLANNED Transfer/Deserialize Template
docs/campaign_packs/c5_2_3_kv_economics.md:47:transfer_bench` or `split_offline`. The `<<DEVICE_PAIR.*>>` placeholders are
docs/campaign_packs/c5_2_3_kv_economics.md:48:the only hardware/device-pair slots; `<<LINK_*>>` placeholders are the only
docs/campaign_packs/c5_2_3_kv_economics.md:49:link slots.
docs/campaign_packs/c5_2_3_kv_economics.md:54:  "run_kind": "transfer_bench",
docs/campaign_packs/c5_2_3_kv_economics.md:55:  "run_id": "c5-2-3-kv-<<DEVICE_PAIR>>-<<LINK_MBPS>>mbps-qwen25-15b-p2048",
docs/campaign_packs/c5_2_3_kv_economics.md:68:  "transfer_bench": {
docs/campaign_packs/c5_2_3_kv_economics.md:72:    "link_label": "<<LINK_LABEL>>",
docs/campaign_packs/c5_2_3_kv_economics.md:73:    "link_speed_mbps": "<<LINK_MBPS>>",
docs/campaign_packs/c5_2_3_kv_economics.md:113:    "power_hz": 10.0,
docs/campaign_packs/c5_2_3_kv_economics.md:118:    "project": "capstone-joulewise",
docs/campaign_packs/c5_2_3_kv_economics.md:120:    "tags": ["c5-2.3", "kv-economics", "transfer", "deserialize"]
docs/campaign_packs/c5_2_3_kv_economics.md:125:Order policy: execute payload sizes in rotated log-spaced order per link and
docs/campaign_packs/c5_2_3_kv_economics.md:126:reverse the order across blocks. If hardware switching forces link blocks,
docs/campaign_packs/c5_2_3_kv_economics.md:127:record link-position and session covariates before registry freeze.
docs/campaign_packs/c5_2_3_kv_economics.md:129:For any future transfer/replay config with `repetitions > 1`, member bundles
docs/campaign_packs/c5_2_3_kv_economics.md:137:Transfer/composite bundles must include:
docs/campaign_packs/c5_2_3_kv_economics.md:145:  transfer/payload_manifest.json
docs/campaign_packs/c5_2_3_kv_economics.md:150:`transfer/payload_manifest.json` records payload bytes, payload SHA-256,
docs/campaign_packs/c5_2_3_kv_economics.md:151:payload kind, predicted bytes, prediction formula inputs, transfer start/end,
docs/campaign_packs/c5_2_3_kv_economics.md:152:and measured throughput. `events.jsonl` must carry `serialize`, `transfer`,
docs/campaign_packs/c5_2_3_kv_economics.md:154:cache-load window on the decode node; cache load is not decode energy.
docs/campaign_packs/c5_2_3_kv_economics.md:156:D-049 labels are required for every transfer cell:
docs/campaign_packs/c5_2_3_kv_economics.md:158:- `host-inclusive transfer energy`
docs/campaign_packs/c5_2_3_kv_economics.md:159:- `board-only lower-bound transfer energy`
docs/campaign_packs/c5_2_3_kv_economics.md:161:Only like-boundary transfer-energy cells may be compared. D-003 metadata must
docs/campaign_packs/c5_2_3_kv_economics.md:162:record wall-clock timestamps, monotonic-vs-wall offsets, NTP state when known,
docs/campaign_packs/c5_2_3_kv_economics.md:174:F-C523-TRANSFER-ECONOMICS: transfer energy/time per GiB.
docs/campaign_packs/c5_2_3_kv_economics.md:176:- x-axis: measured effective throughput (MiB/s) or nominal link label.
docs/campaign_packs/c5_2_3_kv_economics.md:177:- y-axis: transfer energy (J/GiB); companion panel transfer time (s/GiB).
docs/campaign_packs/c5_2_3_kv_economics.md:179:  For unlike boundaries, add: `Boundary labels differ across cells, so absolute energy values are descriptive rather than a calibrated cross-target ranking.`
docs/campaign_packs/c5_2_3_kv_economics.md:184:- y-axis: deserialize/cache-load energy (J) and time (s).
docs/campaign_packs/c5_2_3_kv_economics.md:185:- Caption states that cache load is not decode energy.
docs/campaign_packs/c5_2_3_kv_economics.md:190:- y-axis: prediction error percent and joules where energy is modeled.
docs/campaign_packs/c5_2_3_kv_economics.md:191:- Caption states whether the result is measured transfer/deserialize or
docs/campaign_packs/c5_2_3_kv_economics.md:196:- P1-004 link topology and measured throughput evidence.
docs/campaign_packs/c5_2_3_kv_economics.md:199:- P2-015 floors or AP-specific bounds for transfer/deserialize before L2
docs/campaign_packs/c5_2_3_kv_economics.md:210:bundle-producing step has run: the PLANNED transfer-bench/split-replay commands
docs/campaign_packs/c5_2_3_kv_economics.md:211:below, or v0.1 monolithic reference runs borrowed from the split-suite pack.
docs/campaign_packs/c5_2_3_kv_economics.md:214:python3 -m joulewise kv-size /Users/edr/jw_models/mlx-community/Qwen2.5-1.5B-Instruct-4bit/config.json --prompt-tokens 512,2048,8192
docs/campaign_packs/c5_2_3_kv_economics.md:217:python3 -m joulewise validate-bundle --strict runs/<<BASE_RUN_ID>>__r1
docs/campaign_packs/c5_2_3_kv_economics.md:218:python3 -m joulewise reduce runs/<<BASE_RUN_ID>>__r1
docs/campaign_packs/c5_2_3_kv_economics.md:227:python3 -m joulewise transfer-bench configs/campaign_packs/<<C523_TRANSFER_CONFIG>>.json --runs-dir runs
docs/campaign_packs/c5_2_3_kv_economics.md:230:python3 -m joulewise run configs/campaign_packs/<<C523_SPLIT_REPLAY_CONFIG>>.json --runs-dir runs
docs/campaign_packs/c5_2_3_kv_economics.md:233:python3 -m joulewise kv-economics-reduce runs/bundle_packs/<<PACK_ID>> --output runs/analysis/<<C523_RESULTS>>.json
docs/campaign_packs/c5_2_3_kv_economics.md:246:3. Freeze AP row and manifest with exact runtime/model/link/payload cells,
docs/campaign_packs/c5_2_3_kv_economics.md:250:   with schema `joulewise.order_manifest.v1`, including rotated
docs/campaign_packs/c5_2_3_kv_economics.md:251:   runtime/model/link/payload order and start/end `short_short_sentinel`
docs/campaign_packs/c5_2_3_kv_economics.md:255:   `scripts/generate_matrix.py` for C5-2.3 transfer matrices is a PLANNED
docs/campaign_packs/c5_2_3_kv_economics.md:257:5. Execute transfer/deserialization campaign once planned commands exist.
docs/campaign_packs/c5_2_3_kv_economics.md:259:   (`runs/<base_run_id>__rN`), then compare measured payload, transfer, and
docs/phase_3/phase_3_plan.md:3:(Amendment 2026-07-08, D-048/C-020: the split program is MODEL-FIRST —
docs/phase_3/phase_3_plan.md:4:pre-registered compositional split-energy predictions (from AP-1 Q4
docs/phase_3/phase_3_plan.md:5:coefficients + measured transfer energy) are seeded in an analysis-plan
docs/phase_3/phase_3_plan.md:6:row BEFORE any split hardware runs, and Phase 3 acceptance is framed as
docs/phase_3/phase_3_plan.md:9:binds per-cell transfer-stage boundary labels on discrete-GPU ends.)
docs/phase_3/phase_3_plan.md:24:Decompose disaggregated (split prefill/decode) inference into measured
docs/phase_3/phase_3_plan.md:25:prefill energy, transfer energy, and decode energy, across heterogeneous
docs/phase_3/phase_3_plan.md:28:- Q1: Under what conditions (model size, prompt length, link speed, device
docs/phase_3/phase_3_plan.md:29:  pair) does splitting inference reduce total energy versus running
docs/phase_3/phase_3_plan.md:31:- Q2: How sensitive is the split's energy cost to interconnect bandwidth -
docs/phase_3/phase_3_plan.md:32:  where is the crossover, and does 2.5GbE materially move it versus 1GbE?
docs/phase_3/phase_3_plan.md:33:- Q3: What does the energy-latency trade-off look like - when splitting
docs/phase_3/phase_3_plan.md:34:  saves energy, what latency does it cost (and vice versa)?
docs/phase_3/phase_3_plan.md:43:1. Stage 3.1 *synthetic transfer microbenchmark* - guaranteed deliverable,
docs/phase_3/phase_3_plan.md:45:   baselines supports an analytical split-energy model.
docs/phase_3/phase_3_plan.md:46:2. Stage 3.2 *offline replay* - primary real mechanism: persist prompt
docs/phase_3/phase_3_plan.md:49:3. Stage 3.3 *live split* - stretch only; never a dependency of the phase's
docs/phase_3/phase_3_plan.md:53:real KV transfer; cross-runtime KV portability is out of scope; no borrow
docs/phase_3/phase_3_plan.md:63:Transfer payloads are KV caches; their size is analytically predictable and
docs/phase_3/phase_3_plan.md:65:expected transfer times). Derivation, for standard multi-/grouped-query
docs/phase_3/phase_3_plan.md:86:Expected transfer times at practical TCP throughput (~112 MiB/s on 1GbE,
docs/phase_3/phase_3_plan.md:87:~280 MiB/s on 2.5GbE, ~1120 MiB/s on 10GbE), for a 2048-token prompt:
docs/phase_3/phase_3_plan.md:89:| Model | 1GbE | 2.5GbE | 10GbE |
docs/phase_3/phase_3_plan.md:95:Reading: at 1GbE, transfer time for mid-size models is the same order as
docs/phase_3/phase_3_plan.md:104:model. A `joulewise kv-size` helper (Stage 3.0.0) computes the formula per
docs/phase_3/phase_3_plan.md:118:Objective: `python3 -m joulewise kv-size <model-config.json|params>` printing
docs/phase_3/phase_3_plan.md:134:greedily; diff against an unsplit greedy run of the same prompt.
docs/phase_3/phase_3_plan.md:164:Actions: survey the installed version's KV-transfer/connector APIs;
docs/phase_3/phase_3_plan.md:165:attempt the smallest possible persist-or-transfer demonstration; time-box
docs/phase_3/phase_3_plan.md:169:use llama.cpp-CUDA for split experiments (vLLM remains the monolithic-
docs/phase_3/phase_3_plan.md:181:### Stage 3.1: Schema v0.2 + Transfer Microbenchmark
docs/phase_3/phase_3_plan.md:185:Objective: implement the already-designed config extension before any split
docs/phase_3/phase_3_plan.md:187:Actions: add `run_kind` (default `monolithic`), `split_plan`
docs/phase_3/phase_3_plan.md:188:(prefill_target, decode_target, transfer{method, staging_dir, link_label}),
docs/phase_3/phase_3_plan.md:189:`transfer_bench` block; per-run_kind validation rules; `deserialize` phase
docs/phase_3/phase_3_plan.md:193:(`configs/examples/transfer_bench.json`, `split_offline_example.json`).
docs/phase_3/phase_3_plan.md:198:#### Transfer microbenchmark
docs/phase_3/phase_3_plan.md:200:Objective: measured transfer time and *both-end* transfer energy versus
docs/phase_3/phase_3_plan.md:201:payload size and link, independent of any LLM runtime.
docs/phase_3/phase_3_plan.md:204:- `python3 -m joulewise transfer-bench` config-driven (run_kind
docs/phase_3/phase_3_plan.md:205:  `transfer_bench`): receiver role started on the remote node via the 2K
docs/phase_3/phase_3_plan.md:207:  sample power for the transfer window (telemetry adapters per node);
docs/phase_3/phase_3_plan.md:209:- Clock alignment per D-003: marker events before/after; offset bound in
docs/phase_3/phase_3_plan.md:211:- Energy attribution per methodology: sender energy and receiver energy
docs/phase_3/phase_3_plan.md:213:- Loopback mode (localhost) for CI smoke - no energy meaning, exercises
docs/phase_3/phase_3_plan.md:216:  motivated), n>=3 per point per link.
docs/phase_3/phase_3_plan.md:221:Evidence: loopback CI test; real-pair bundles with energy/GiB numbers in a
docs/phase_3/phase_3_plan.md:222:run report; link verification commands recorded per the Phase 1 exit
docs/phase_3/phase_3_plan.md:224:Acceptance: energy/GiB and effective throughput with uncertainty for at
docs/phase_3/phase_3_plan.md:225:least one real link; methodology's clock-offset bound respected.
docs/phase_3/phase_3_plan.md:230:### Stage 3.2: Offline Split Runs (Replay)
docs/phase_3/phase_3_plan.md:232:Objective: real split measurements: prefill on node A (measured), cache file
docs/phase_3/phase_3_plan.md:233:transferred (measured by the 3.1 machinery), decode-from-cache on node B
docs/phase_3/phase_3_plan.md:239:  stage boundaries emit `serialize`/`transfer`/`deserialize` phase events;
docs/phase_3/phase_3_plan.md:240:  the transfer leg reuses the 3.1 path (same code, real payload).
docs/phase_3/phase_3_plan.md:245:  config.json                  (split config, v0.2)
docs/phase_3/phase_3_plan.md:246:  metadata.json                (composite; per-node clock bounds)
docs/phase_3/phase_3_plan.md:248:  summary_metrics.json         (composite: per-stage energy decomposition)
docs/phase_3/phase_3_plan.md:249:  transfer/payload_manifest.json
docs/phase_3/phase_3_plan.md:255:  serialize = cache-persist call window on A; transfer = byte-movement
docs/phase_3/phase_3_plan.md:257:  last-token on B. Cache load is *not* part of decode energy.
docs/phase_3/phase_3_plan.md:260:  serving, not a per-request split cost); recorded explicitly in
docs/phase_3/phase_3_plan.md:268:Actions: implement split orchestration for the pairings green-lit by 3.0.4;
docs/phase_3/phase_3_plan.md:269:run smoke splits on the cheapest available pair; then measured splits
docs/phase_3/phase_3_plan.md:270:(n>=3) for each feasible pairing at one link speed.
docs/phase_3/phase_3_plan.md:271:Evidence: composite bundles validating; per-stage energy decomposition
docs/phase_3/phase_3_plan.md:273:Acceptance: at least one pairing produces complete split decomposition
docs/phase_3/phase_3_plan.md:274:(prefill_E, transfer_E, deserialize_E, decode_E) with uncertainty; every
docs/phase_3/phase_3_plan.md:276:Fallback: R-004/R-005 ladders - analytical composition using 3.1 transfer
docs/phase_3/phase_3_plan.md:277:energy + Phase 2 phase-attributed baselines; reported as modeled, never as
docs/phase_3/phase_3_plan.md:280:### Stage 3.3: Live Split (Stretch)
docs/phase_3/phase_3_plan.md:286:socket streaming of the cache buffer; same composite bundle; `split_live`
docs/phase_3/phase_3_plan.md:288:Acceptance: one live split run decomposed as in 3.2; comparison live vs
docs/phase_3/phase_3_plan.md:289:offline overhead reported.

exec
/bin/zsh -lc "sed -n '1,330p' docs/phase_3/phase_3_plan.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '331,520p' docs/phase_3/phase_3_plan.md && sed -n '1,131p' docs/phase_2/splitwise_replication_roadmap.md && sed -n '1,220p' docs/campaign_packs/q6_c5_2_10_rail_vs_wall.md" in /private/tmp/claude-501/-Users-edr-code-JouleWise/58ce57f7-1ee6-4b35-a1b3-457ccf40dff7/scratchpad/desk
 succeeded in 0ms:
...
codex
A key quantitative point is emerging: the Mac’s ~5 J bar cannot be transported to the composite split result. At 10 Hz, a 300 W-class PC or combined wall boundary can turn one uncertain sample edge into tens of joules, so the split study must mint new endpoint and wall/composite floors and lengthen transfer workloads. I’m verifying the hardware/venue facts against primary sources before finalizing the budget.
web search: 
web search: site:spec.org ICPE 2027 research track official ...
web search: 
web search: 
codex
# From One Boundary to Two: Fail-Closed Energy Metrology for Split LLM Inference

**Thesis:** Split-inference energy claims are credible only when each device, the transfer interval, cross-device clocks, and the combined physical boundary carry calibrated uncertainty—and the method refuses conclusions that those bounds cannot resolve.

## Project brief and steps

JouleWise already has the scientific spine of this paper: a calibrated `powermetrics` instrument for one named M3 Max/MLX/Qwen2.5-4-bit stack; the finding that phase measurement is attribution-limited rather than noise-limited; separately enforced floor-clearance and directional-interval gates; and a hash-bound, fail-closed protocol that preserves refusals. The immediate priority remains D-117, not split engineering. First finish its desk blockers—two-slot live calibration brackets, acceptance-successor machinery, four-cell decode/prefill minting, frozen extraction specifications, and the synthetic three-window ledger regression. Then collect Alpha (1.5B decode and prefill floors, 3.14 h), Beta (7B floors, 3.24 h), and Gamma (fresh 1.5B-versus-7B decode contrast, 2.80 h), mint the four phase-floor cells, and populate `draft-v1.md`. Those results establish the single-boundary instrument and provide this paper’s baseline evidence; old pre-genesis values remain diagnostics only.

Only afterward should Ed fund the split extension. Its honest minimum is synthetic transfer characterization plus one offline cache-replay pairing—not live distributed serving. Before a split night, complete cross-machine cache-portability and output-identity spikes, schema v0.2/composite bundles, NVIDIA and wall-meter importers, two-clock interval propagation, transfer/composite floor definitions, and pre-registered model-first predictions. The realistic budget is **six claim windows total**: the three D-117 nights plus three 2–4 h two-device windows, with one non-claim wall-meter pilot and one contingency session. Live split remains stretch work.

## Contributions

1. **Two-boundary calibration:** demonstrate that independently calibrated Mac, NVIDIA, wall-meter, and cross-clock intervals contain every injected transfer-pulse boundary under the pre-registered acceptance rule—or publish the failing operating domain.

2. **Transfer-specific detection floors:** mint absolute and ABBA comparative floors for sender, receiver, combined-wall, and composite split energy; deliberately show that sub-floor transfer differences are refused and longer effects are resolved.

3. **Auditable composite accounting:** show whether `prefill + serialize + transfer + deserialize + decode` reconciles with the combined wall-meter request interval inside its propagated bound, without double-counting warm-node or fixed terms.

4. **One real offline split result:** for a pinned same-runtime Qwen2.5 pairing, determine whether split energy is lower, higher, or not resolvable relative to **both** monolithic references while preserving greedy token identity.

## Experiment plan

The split extension uses three windows:

- **S1—instrument and transfer floors:** synthetic 16, 64, 256, and 1024 MiB payloads over measured 1GbE and 2.5GbE, using long outer-window pulse trains and ABBA ordering. Short transfers are characterization probes, not automatically claimable stages.

- **S2—1.5B offline replay:** Qwen2.5-1.5B, prompt lengths 2,048 and 8,192, decode 256, both links, n=5 per headline cell, with contemporaneous monolithic references on both devices.

- **S3—confirmation:** n=10 for the prospectively predicted crossover or strongest no-crossover cell; use 7B only if its portability, runtime, and four-bit artifact gates pass.

Repo-grounded payloads are 56/224 MiB for 1.5B and 112/448 MiB for 7B at 2,048/8,192 prompt tokens. Expected 1.5B transfer times are approximately 0.5/2.0 s on 1GbE and 0.2/0.8 s on 2.5GbE. Assuming, very uncertainly, 20–100 W incremental combined activity, those imply roughly **10–50 J / 40–200 J** on 1GbE and **4–20 J / 16–80 J** on 2.5GbE. Thus long-prompt transfers should exceed the Mac’s ~5 J sizing bar; the 2,048-token 2.5GbE cell may not.

Crucially, ~5 J is only a Mac phase-design reference. A 100 ms uncertain edge on a high-power PC can be tens of joules; NVIDIA specifies up to 350 W graphics-card power for the 3080 Ti. [NVIDIA specifications](https://www.nvidia.com/en-gb/geforce/graphics-cards/30-series/rtx-3080-3080ti/) Serialize and deserialize may also refuse: the existing MLX diagnostic measured only ~14 ms save and ~0.4 ms load at 1,024 tokens. Such a refusal means the substage is not independently resolvable—not that it costs zero—while the longer composite interval may remain claimable.

This preserves the frozen single-request boundary: offline replay is one sequential logical request across two warm nodes; synthetic pulse trains characterize the instrument, not serving throughput.

## Hardware and instrument needs

Owned: M3 Max, RTX 3080 Ti rig, direct 1GbE/2.5GbE paths if topology verification passes, `powermetrics`, and NVIDIA telemetry. Borrow: an in-calibration WT310E plus an advisor-approved inline fixture and shared power strip. Its 100 ms update mode and range-dependent accuracy must enter the floor calculation. [Yokogawa specification](https://cdn.tmi.yokogawa.com/BUWT300E_01EN.pdf)

**Wall-meter dependency: yes** for the headline split-versus-monolithic total. One meter can observe the pair’s combined AC boundary while the unused reference node remains powered and idle. Without it, endpoint results remain heterogeneous SoC-rail versus GPU-board measurements and cannot support an energy-winner claim.

## Venue fit and relation to the MVP

The D-117 paper alone is a strong capstone/CSCSU-style paper. A completed S1 plus partial replay fits an ICPE Emerging/WIP submission; a wall-validated composite, empirical split floors, and at least one complete replay pairing could support an ICPE full-track attempt. ICPE explicitly covers performance measurement, modeling, distributed systems, and energy efficiency. [ICPE scope](https://icpe.spec.org/)

The paper reuses the MVP’s motivation and essentially all of §§3–5: pulse calibration, corner-propagated floors, drift, ABBA, custody, and refusal semantics. It also reuses all three D-117 datasets as the validated one-boundary baseline. New material is the second telemetry backend, cross-clock bounds, wall/composite boundary, transfer stages, and offline split case study. D-117 MLX results are **not** direct monolithic comparators for a llama.cpp split stack.

## Risks and kill criteria

Spend no split night unless:

- cross-machine cache restore preserves all greedy tokens and exact artifact identity;
- both clocks produce a prospective bound smaller than 25% of the shortest claimed interval;
- the wall meter has current calibration, fixed export cadence, and a safe fixture;
- schema v0.2 bundles validate and re-reduce from raw evidence;
- desk pilots predict at least one contrast above twice the provisional composite floor;
- 3080 Ti access and both measured links are scheduled.

If portability fails, stop at synthetic transfer metrology and keep split as a capstone extension/future-work result—not a standalone “split saves energy” paper.

## Relation to Ed’s original goals

This directly serves Ed’s original **SPLIT/disaggregated inference** axis and advances the modular harness: device, runtime, link, workload, and placement become swappable but boundary-labelled experiment axes. It also restores energy as a rigorous third metric beside latency and output equivalence. It does not advance speculative decoding, MTP, MoE routing, or KDA.
tokens used
158,528
# From One Boundary to Two: Fail-Closed Energy Metrology for Split LLM Inference
