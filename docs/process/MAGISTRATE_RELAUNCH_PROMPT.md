...
Then email Ed that you are standing down, stop every Codex child and background process you started, and exit within two minutes of the request. This cooperative window is a courtesy, not a guarantee: for a plan, the resident ladder TERMs at t0−3 minutes and KILLs at t0−2 minutes regardless of when the request arrives.
