...
`PLAN_LEAD_S = 300 = 5 × 60 s` and `INSTALL_CLOSE_MARGIN_S = 120 = 2 × 60 s`,
so close is `t0 − 7 min`. Installation must also be inside one entry of
...
**LEAD-MARGIN-01:** the two-minute install pad and 5/5/3/2-minute
plan/request/TERM/KILL leads give a **seven-minute exclusive install floor**.
The request allows two minutes for cooperative exit as a courtesy; TERM at
t0−3 and KILL at t0−2 still apply after a late request. The census needs the
whole tree and supervisor gone; load decay needs about two to three minutes
after teardown. The 10-second resident poll fits both phase gaps (12/6 polls),
...
| Plan install close (exclusive) | 2026-09-16 02:49:00 PDT | `1789552560 − 300 − 120 = 1789552140` |
...
| Plan span opens; request / activation exit boundary | 2026-09-16 02:51:00 PDT | `1789552560 − 300 = 1789552260` |
| TERM deadline | 2026-09-16 02:53:00 PDT | `1789552560 − 3 × 60 = 1789552380` |
| KILL deadline | 2026-09-16 02:54:00 PDT | `1789552560 − 2 × 60 = 1789552440` |
...
> Plan span: `<t0 − 5 min local + epoch>` through `<completion local + epoch>`,
...
> The arming activation exits before `<t0 − 5 min local + epoch>`.
