...
| MDE/n sizing + predeclared top-up rule | Preserve at least 3 marked items for P2-022 feasibility and n>=5 repeated harness bundles or an accepted repeated-block design for L2 overhead comparisons. Sizing authority: D-062 + `configs/analysis_registry/<<C5I4_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
