...
| MDE/n sizing + predeclared top-up rule | Preserve n>=5 paired blocks per primary workload family. Sizing authority: D-062 + `configs/analysis_registry/<<Q6_C5210_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
