...
| MDE/n sizing + predeclared top-up rule | n>=5 for headline pairing cells; n>=3 minimum for non-headline cells. Top up to n=10 before Q1 L2 wording when either split-vs-monolithic-reference CI touches the active floor gate, when a crossover verdict changes under leave-one-out, or when D-048 prediction error is near the floor. Top-up rules are governed by D-062 (frozen n; demotion on outcome-dependent growth). |
...
| MDE/n sizing + predeclared top-up rule | n>=3 per payload x link cell, n>=5 for headline link contrast. Top up to n=10 when the link contrast CI crosses the active floor gate or when the nominal crossover position changes under leave-one-out. Top-up rules are governed by D-062 (frozen n; demotion on outcome-dependent growth). |
...
| MDE/n sizing + predeclared top-up rule | n follows Q1/Q2 source cells; top up before Pareto-frontier language when any dominance verdict changes under leave-one-out or when the energy contrast is near the active floor gate. Top-up rules are governed by D-062 (frozen n; demotion on outcome-dependent growth). |
