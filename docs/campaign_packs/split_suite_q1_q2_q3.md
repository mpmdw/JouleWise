...
| MDE/n sizing + predeclared top-up rule | Headline pairing cells: n=10 when Window-A evidence expects a near-floor contrast (D-048 prediction error near floor, or contrast MDE within 2x of the floor gate), n>=5 otherwise; n>=3 minimum for non-headline cells. Sizing authority: D-062 + `configs/analysis_registry/<<SPLIT_Q1_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
...
| MDE/n sizing + predeclared top-up rule | Headline link contrast: n=10 when Window-A evidence marks it near-floor, otherwise n>=5; n>=3 per payload x link cell. Sizing authority: D-062 + `configs/analysis_registry/<<SPLIT_Q2_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
...
| MDE/n sizing + predeclared top-up rule | n follows the Q1/Q2 source cells. Sizing authority: D-062 + `configs/analysis_registry/<<SPLIT_Q3_ANALYSIS_REGISTRY>>.json` (frozen n; no outcome-based top-ups without demotion). |
