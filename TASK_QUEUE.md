...
| 16 | P2-005 | P2 Next Slice | 2K fixture-first MERGED (PR #11, 2026-07-08); NV-GATE-2 CODE-NOW units implemented 2026-07-10 on `impl/nvgate2-codenow` without live promotion: NV-1 include-usage/fallback path, NV-3 strict NVIDIA lineage registry, NV-4 cleanup/process demotion, NV-5 subprocess contract test (localhost execution loudly skipped where sandbox denied sockets); ALL protocol pins remain PROVISIONAL; live validation gated (P1-006, evidence script ready: `docs/phase_1/2k_live_verification_checklist.md`); 2L Orin open; before 2K live: pin richer nvidia-smi query fields (clocks/pstate/throttle-reasons/memory; C-015/R2); NV-GATE-2 live-window acceptance remains: capture stream-vs-token semantics and execute live rows 16–20 | Remote targets (slices 2K NVIDIA/vLLM/ssh, 2L Orin) | Code-now evidence: `docs/run_reports/2026-07-10-nvgate2-codenow.md`; remote bundle or documented access blocker; applicability table updated. Spec in the hardware-slice guide. |
