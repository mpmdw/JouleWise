...
|---:|---|---|---|---|---|
| 0 | P2-015-PREP | P2 Next Slice | NEW (CP-6 adjudication 2026-07-09: accepted synthesis condition; the only remaining pre-window agent work) [AGENT] | P2-015 detection-floor DESIGN DOC: cell list, n per cell (n>=10 where feasible), UCB floor rule, Window-B-start same-config revalidation cell + tolerance | `docs/phase_2/detection_floor.md` design section committed BEFORE the quiet window; campaign sizing derivable from it; 5.5 counterreview of the doc |
