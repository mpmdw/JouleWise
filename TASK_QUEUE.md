...
| 0e | P2-034 | P2 Next Slice | NEW (C-025; cut-line SATISFIED by P2-033 linter, D-059) [AGENT] | Broad campaign packs: C5-2.7/2.8, C5-3.1/3.5 replication runbook, C5-I.1..I.5 interop contracts | Same pack shape as P2-032; every draft AP row must pass `scripts/claims_lint.py --mode pack` |
