...
| 4 | P3-000 | P3 Research Expansion | 3.0.1 COMPLETE on `stream/kv-spike-301` @ 54e4f18 (2026-07-07 PM): verdict **replay_supported**, cache size matches kv-size prediction to +0.018%; pending lead one-command re-verify + merge. Next spikes 3.0.2+ open [AGENT] | KV persistence feasibility spikes (Phase 3 Stage 3.0) — 3.0.1 (mlx-lm prompt-cache) runs ahead of P2-010/P2-012 per C-007 (feasibility verdicts before feature buildout) | Verdicts in `docs/phase_3/kv_feasibility.md`; must complete before any borrow-window scheduling |
