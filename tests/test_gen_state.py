...
EXPECTED_IDS = {
    ...
    "T0-CLEAN-TREE-CHECK-01",
    "KIND-TABLE-WINDOW-MUTANT-TEST-01",
...
TERMINAL_IDS = {"ARM-CENSUS-BROWSER-PROBE-SYSTEM-SERVICES-01", "ESTIMAND-ENCLOSURE-01", "FB-PLANNING-METADATA-01", "D165-RELABEL-01", "PAPER-K",
