...
**Current checkpoint: T38r (2026-09-14 ~16:50 PDT), the equivalence night `d079-epoch-25g83-derivation-n1-20260915` is ARMED for t0 Tue 2026-09-15 02:56:00 PDT (installed the evening before under Ed's directive #336); directive #337 (windows whenever quiet, Fable terminal eyes, Ed-hands prep) received for after the night.** Start with T38r below, the durable pointer's last UPDATE line in [00-DURABLE-STATE.md](docs/process_traces/2026-09-02-hands-free-week/00-DURABLE-STATE.md), and the activation records under `docs/process_traces/2026-09-13-activation-24b9d3dd/`. Every prior checkpoint remains verbatim.
...
Source of truth for work selection: [state kernel](docs/process/state_kernel.json) (updated 2026-09-14). Latest report: [T38d — 2026-09-09: rehearsal harvest, stub-chain finding and post-completion cleanup](docs/process_traces/2026-09-02-hands-free-week/21i-rehearsal-20260909-harvest-record.md).
