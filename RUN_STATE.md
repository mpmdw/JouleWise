...
**D-176 installation (2026-09-08) — stage-3 ruling adopted; contract draft awaits wire ruling and Opus refutation.** The six decisions and stage-3 kernel graph are installed from packet 78's magistrate synthesis. `NIGHT-PACK-REHEARSAL-01` is registered; D-176 opens the build-authority starts while the implementation and live-close dependencies remain pending. The seat-1 contract is `docs/contracts/pack_night_go_receipt.md`; its §8 identifies unpinned GO identity/replay path, attempt and claim-eligibility placement, and record encodings. Next exact step: the lead rules those details, then the Opus refuter reviews the contract before it lands and any code scope is issued. No code/live closure or arming is claimed. Installation evidence: `docs/process_traces/2026-09-08-handoff-redo/85-d176-install-astra-report.md`. The T38/T38b notes below remain historical on the stage-3 ruling status.
...
Source of truth for work selection: [state kernel](docs/process/state_kernel.json) (updated 2026-09-08). Latest report: [2026-09-08 D-176 decision, kernel and seat-1 contract installation; wire ruling pending](docs/process_traces/2026-09-08-handoff-redo/85-d176-install-astra-report.md).
