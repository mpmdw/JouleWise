...
**Current checkpoint: T38k (2026-09-10 ~19:55 PDT), ACCEPTANCE-EPOCH-25G83-01 implementation MERGED (PR #315 → main 8cbcaf08); rehearsal-20260911 remains ARMED and untouched; the derivation-night arm goes through NIGHT_HANDBACK from the next activation.** Start with T38k below, the durable pointer's last UPDATE line in [00-DURABLE-STATE.md](docs/process_traces/2026-09-02-hands-free-week/00-DURABLE-STATE.md), the derivation-night runbook draft [99](docs/process_traces/2026-09-10-activation-96bfeca7/99-derivation-night-runbook-draft.md), and, for the 09-11 harvest, the supersession banner in [13-activation-checklist-2026-09-11.md](docs/process_traces/2026-09-10-activation-96bfeca7/13-activation-checklist-2026-09-11.md). Every prior checkpoint remains verbatim.
