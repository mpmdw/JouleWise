...
Source of truth for work selection: [state kernel](docs/process/state_kernel.json) (updated 2026-09-23). Latest report: [Activation d8cc9c0a record: headline gates, stopped draft, and next actions](docs/process_traces/2026-09-23-activation-d8cc9c0a/00-activation-record.md).
