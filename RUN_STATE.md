...
**Current checkpoint: T38j (2026-09-10 ~08:10 PDT), OS-build epoch blocker confirmed (record 39); ACCEPTANCE-EPOCH-25G83-01 registered; the 09-12 G2-a arm is off; rehearsal-20260911 remains ARMED and untouched.** Start with T38j below, the durable pointer's last UPDATE line in [00-DURABLE-STATE.md](docs/process_traces/2026-09-02-hands-free-week/00-DURABLE-STATE.md), and, for the 09-11 activation, the supersession banner in [13-activation-checklist-2026-09-11.md](docs/process_traces/2026-09-10-activation-96bfeca7/13-activation-checklist-2026-09-11.md). Every prior checkpoint remains verbatim.
