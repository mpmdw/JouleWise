...
- **B0: PARKED for a cold gate** (escalation, item 70). The parity harness `eb8d745f` (branch `test/2026-09-24-b0-idle-parity`) has 0 self-mismatches, and 19,615 outcome mismatches at `bee658c5` (item 75). Next cold gate: approve a fix round whose acceptance test is the harness GREEN.
