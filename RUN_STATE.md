...
**Current checkpoint: T38n (2026-09-12 ~07:45 PDT, activation `f0d28baa`): DESK DAY UNDER THE ARMED EQUIVALENCE NIGHT — four tests-and-fixtures PRs merged under the twelve-row gate (#326 git-fixture census, #325 `calibration_window_exhausted` refusal code + runbook paragraph, #327 arm-readiness fixture clock origin, #324 controller sentinel stress), two rule-11 cold gates ruled (28: the runbook paragraph; 50: the isolation rule covers mechanism clauses, not a test's terminal oracles), replay 4 on the integration tree 6047 tests / 0 failures; `d079-epoch-25g83-derivation-n1-20260913` remains ARMED and untouched at H f90cb8c0 for t0 02:56 09-13.** Start with T38n below and the durable pointer's last UPDATE line in [00-DURABLE-STATE.md](docs/process_traces/2026-09-02-hands-free-week/00-DURABLE-STATE.md). Previous checkpoint T38m (2026-09-12 00:40 PDT, night courier): rehearsal-20260912 FIRED at 00:30 from the launchd-started driver on the cured head, result `REHEARSAL_ONLY` / chain exit 0 / `launchd.night.err` empty; ruling 06 C-7 fully MET → NIGHT-REHEARSAL-01 item 6 MET; C-8 retirement on disk (agents uninstalled, stub checkout removed, plan root out of discovery); NOTHING ARMED; next = equivalence-night install 03:00–06:30 PDT 09-12 for t0 02:56 09-13 (item 4 stage-1 email owed before that arm).** Previous checkpoint T38l (2026-09-10 ~23:35 PDT): Ed's ruling by directive issue 316 is recorded on main (PR #319 → `e95bc22a`): night one is an EPOCH-EQUIVALENCE CHECK against the envelope already in force, not the first of three blind derivation nights; the continuation mechanism the PASS route needs is still in the gate on its branch. Start with T38l below, the durable pointer's last UPDATE line in [00-DURABLE-STATE.md](docs/process_traces/2026-09-02-hands-free-week/00-DURABLE-STATE.md), the tracked derivation-night runbook [docs/phase_2/derivation_night_runbook.md](docs/phase_2/derivation_night_runbook.md) at revision 6 (§2.5 is the equivalence rule; it supersedes the draft record 99), and, for the 09-11 harvest, the supersession banner in [13-activation-checklist-2026-09-11.md](docs/process_traces/2026-09-10-activation-96bfeca7/13-activation-checklist-2026-09-11.md). Every prior checkpoint remains verbatim.
...
Source of truth for work selection: [state kernel](docs/process/state_kernel.json) (updated 2026-09-12). Latest report: [T38d — 2026-09-09: rehearsal harvest, stub-chain finding and post-completion cleanup](docs/process_traces/2026-09-02-hands-free-week/21i-rehearsal-20260909-harvest-record.md).
