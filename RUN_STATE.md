...
- **B0: PARKED for a cold gate** (escalation, item 70). The parity harness (brief 80, Astra) is running on `test/2026-09-24-b0-idle-parity`; commit its output. Next cold gate: approve a fix round whose acceptance test is the harness GREEN.
