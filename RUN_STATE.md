...
3. **Acceptance v4 PR** `53e6d23d`: the Sol lens found 1 should_fix (the v3-identity/v4-pin exception is too broad; confine it to r8), and the Opus lens is running. Then a fix round, then the cold gate (waits on Fable), then r8, then the rev 4 seal and W1.
